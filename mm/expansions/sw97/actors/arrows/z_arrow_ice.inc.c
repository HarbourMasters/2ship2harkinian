...
// ============================================================================
// Graphics data (merged from z_arrow_ice_gfx.c)
// ============================================================================

static UNK_TYPE sArrowIceTexture1[] = {
...
static UNK_TYPE sArrowIceTexture2[] = {
...
static UNK_TYPE sArrowIceVertices1[] = {
...
static UNK_TYPE sArrowIceVertices2[] = {
...
static Gfx sArrowIceTextureDL[] = {
    gsDPPipeSync(),
    gsDPSetTextureLUT(G_TT_NONE),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPLoadTextureBlock(sArrowIceTexture2, G_IM_FMT_I, G_IM_SIZ_8b, 32, 64, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_MIRROR | G_TX_WRAP, 5, 6, 1, 15),
    gsDPLoadMultiBlock(sArrowIceTexture1, 0x0100, 1, G_IM_FMT_I, G_IM_SIZ_8b, 32, 64, 0, G_TX_NOMIRROR | G_TX_WRAP,
...
static Gfx sArrowIceVertexDL[] = {
    gsSPVertex(sArrowIceVertices1, 32, 0),
    ...
    gsSPVertex(sArrowIceVertices2, 11, 0),
...
static const ALIGN_ASSET(2) char sSw97IceMatDL[] = "__OTR__overlays/ovl_Arrow_Ice/sMaterialDL";
static const ALIGN_ASSET(2) char sSw97IceMdlDL[] = "__OTR__overlays/ovl_Arrow_Ice/sModelDL";
...
static InitChainEntry sArrowIceInitChain[] = {
...
void ArrowIce_Init(Actor* thisx, PlayState* play) {
    ...
    Actor_ProcessInitChain(&this->actor, sArrowIceInitChain);
    this->radius = 0;
    this->unk_160 = 1.0f;
...
void ArrowIce_Charge(ArrowIce* this, PlayState* play) {
    ...
    Actor_PlaySfx_Flagged2(&this->actor, NA_SE_PL_ARROW_CHARGE_ICE - SFX_FLAG);
...
static void ArrowIce_LerpPos(Vec3f* unkPos, Vec3f* icePos, f32 scale) {
...
void ArrowIce_Draw(Actor* thisx, PlayState* play) {
    ...
    if ((arrow != NULL) && (arrow->actor.update != NULL) && (this->timer < 255)) {
        ...
        gSPDisplayList(POLY_XLU_DISP++, sSw97IceMatDL);
        gSPDisplayList(POLY_XLU_DISP++,
                       Gfx_TwoTexScroll(play->state.gfxCtx, 0, 511 - (stateFrames * 5) % 512, 0, 128, 32, 1,
                                        511 - (stateFrames * 10) % 512, 511 - (stateFrames * 10) % 512, 4, 16));
        gSPDisplayList(POLY_XLU_DISP++, sSw97IceMdlDL);
