...
// ============================================================================
// Struct (merged from z_arrow_fire.h)
// ============================================================================
...
// ============================================================================
// Graphics data (merged from z_arrow_fire_gfx.c)
// ============================================================================

static UNK_TYPE sArrowFireTexture1[] = {
...
static UNK_TYPE sArrowFireTexture2[] = {
...
static UNK_TYPE sArrowFireVertices1[] = {
...
static UNK_TYPE sArrowFireVertices2[] = {
...
static Gfx sArrowFireTextureDL[] = {
    gsDPPipeSync(),
    gsDPSetTextureLUT(G_TT_NONE),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPLoadTextureBlock(sArrowFireTexture1, G_IM_FMT_I, G_IM_SIZ_8b, 32, 64, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_MIRROR | G_TX_WRAP, 5, 6, 1, 15),
    gsDPLoadMultiBlock(sArrowFireTexture2, 0x0100, 1, G_IM_FMT_I, G_IM_SIZ_8b, 32, 64, 0, G_TX_NOMIRROR | G_TX_WRAP,
...
static Gfx sArrowFireVertexDL[] = {
    gsSPVertex(sArrowFireVertices1, 32, 0),
    ...
    gsSPVertex(sArrowFireVertices2, 11, 0),
...
static const ALIGN_ASSET(2) char sSw97FireMatDL[] = "__OTR__overlays/ovl_Arrow_Fire/sMaterialDL";
static const ALIGN_ASSET(2) char sSw97FireMdlDL[] = "__OTR__overlays/ovl_Arrow_Fire/sModelDL";
...
static InitChainEntry sArrowFireInitChain[] = {
...
void ArrowFire_Init(Actor* thisx, PlayState* play) {
    ...
    Actor_ProcessInitChain(&this->actor, sArrowFireInitChain);
    this->radius = 0;
    this->unk_158 = 1.0f;
...
void ArrowFire_Charge(ArrowFire* this, PlayState* play) {
    ...
    Actor_PlaySfx_Flagged2(&this->actor, NA_SE_PL_ARROW_CHARGE_FIRE - SFX_FLAG);
...
static void ArrowFire_LerpPos(Vec3f* unkPos, Vec3f* firePos, f32 scale) {
