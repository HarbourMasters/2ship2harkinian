...
// ============================================================================
// Struct (merged from z_arrow_light.h)
// ============================================================================
...
// ============================================================================
// Graphics data (merged from z_arrow_light_gfx.c)
// ============================================================================

static UNK_TYPE sArrowLightTexture1[] = {
...
static UNK_TYPE sArrowLightTexture2[] = {
    0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000,
    0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000,
    0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000,
...
static UNK_TYPE sArrowLightVertices1[] = {
...
static UNK_TYPE sArrowLightVertices2[] = {
...
static Gfx sArrowLightTextureDL[] = {
    gsDPPipeSync(),
    gsDPSetTextureLUT(G_TT_NONE),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPLoadTextureBlock(sArrowLightTexture1, G_IM_FMT_I, G_IM_SIZ_8b, 32, 64, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_MIRROR | G_TX_WRAP, 5, 6, 13, 15),
    gsDPLoadMultiBlock(sArrowLightTexture2, 0x0100, 1, G_IM_FMT_I, G_IM_SIZ_8b, 32, 64, 0, G_TX_NOMIRROR | G_TX_WRAP,
...
static Gfx sArrowLightVertexDL[] = {
    gsSPVertex(sArrowLightVertices1, 32, 0),
    ...
    gsSPVertex(sArrowLightVertices2, 11, 0),
...
static const ALIGN_ASSET(2) char sSw97LightMatDL[] = "__OTR__overlays/ovl_Arrow_Light/sMaterialDL";
static const ALIGN_ASSET(2) char sSw97LightMdlDL[] = "__OTR__overlays/ovl_Arrow_Light/sModelDL";
...
static InitChainEntry sArrowLightInitChain[] = {
...
void ArrowLight_Init(Actor* thisx, PlayState* play) {
    ...
    Actor_ProcessInitChain(&this->actor, sArrowLightInitChain);
    this->radius = 0;
    this->unk_160 = 1.0f;
...
static void ArrowLight_LerpPos(Vec3f* unkPos, Vec3f* lightPos, f32 scale) {
...
void ArrowLight_Draw(Actor* thisx, PlayState* play) {
    ...
    if ((arrow != NULL) && (arrow->actor.update != NULL) && (this->timer < 255)) {
        ...
        if (this->unk_164 > 0) {
            ...
            gDPSetPrimColor(POLY_XLU_DISP++, 0, 0, (s32)(50.0f * this->unk_164) & 0xFF,
                            (s32)(50.0f * this->unk_164) & 0xFF, (s32)(50.0f * this->unk_164) & 0xFF,
