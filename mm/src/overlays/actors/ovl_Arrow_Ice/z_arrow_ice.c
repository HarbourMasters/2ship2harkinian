...
void ArrowIce_Draw(Actor* thisx, PlayState* play) {
    ...
    if ((arrow != NULL) && (arrow->actor.update != NULL) && (this->timer < 255)) {
        ...
        gDPSetPrimColorWithOverride(POLY_XLU_DISP++, 0x80, 0x80, 170, 255, 255, (s32)(this->alpha * 0.5f) & 0xFF,
                                    "Effects.IceArrowPrim");
        gDPSetEnvColorWithOverride(POLY_XLU_DISP++, 0, 0, 255, 128, "Effects.IceArrowSec");
