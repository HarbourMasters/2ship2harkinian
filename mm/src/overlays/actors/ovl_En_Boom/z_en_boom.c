...
void EnBoom_Init(Actor* thisx, PlayState* play) {
    ...
    Color_RGBA8 trailColor = CosmeticEditor_GetChangedColor(255, 255, 100, 255, COSMETIC_ELEMENT_ZORA_BOOMERANG_TRAIL);
    ...
    for (i = 0; i < 4; i++) {
        sp30.p1StartColor[i] = (i < 3) ? ((i == 0)   ? trailColor.r
                                          : (i == 1) ? trailColor.g
                                                     : trailColor.b)
                                       : D_808A3068[i];
        sp30.p2StartColor[i] = (i < 3) ? ((i == 0)   ? trailColor.r
                                          : (i == 1) ? trailColor.g
                                                     : trailColor.b)
                                       : D_808A306C[i];
        sp30.p1EndColor[i] = (i < 3) ? ((i == 0)   ? trailColor.r
                                        : (i == 1) ? trailColor.g
                                                   : trailColor.b)
                                     : D_808A3070[i];
        sp30.p2EndColor[i] = (i < 3) ? ((i == 0)   ? trailColor.r
                                        : (i == 1) ? trailColor.g
                                                   : trailColor.b)
                                     : D_808A3074[i];
    }
