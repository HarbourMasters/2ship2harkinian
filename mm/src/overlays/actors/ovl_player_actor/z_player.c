...
void Player_Action_93(Player* this, PlayState* play) {
    ...
    if (this->av1.actionVar1 == 0) {
        ...
        if (this->unk_ABC < -3900.0f ||
            (CVarGetInteger("gEnhancements.PlayerMovement.FastFlowerLaunch", 0) && this->unk_ABC < -1800.0f)) {
        ...
        if (!CHECK_BTN_ALL(sPlayerControlInput->cur.button, BTN_A)) {
            if (func_80856000(play, this)) {
                ...
                if (this->av2.actionVar2 >= 10 || CVarGetInteger("gEnhancements.PlayerMovement.FastFlowerLaunch", 0)) {
        ...
        if (temp_fv0_2 >= 0.0f) {
            ...
            if (CVarGetInteger("gEnhancements.PlayerMovement.FastFlowerLaunch", 0)) {
