...
typedef struct FileSelectState {
    ...
    /* 0x24414 */ unsigned char fileNames[FILE_NUM_MAX_WITH_OWL_SAVE][8];
...
void FileSelect_JP_Destroy(GameState* thisx);
...
// Copied Struct to get macro glue to work

typedef struct FileSelect_JPState {
    /* 0x00000 */ GameState state;
    /* 0x000A4 */ Vtx* windowVtx;
    /* 0x000A8 */ u8* staticSegment;
    /* 0x000AC */ u8* parameterSegment;
    ...
    /* 0x2454E */ s16 unk_2454E;
    /* 0x24550 */ s16 unk_24550;
} FileSelect_JPState; // size = 0x24558

extern u8 D_808153D0_cj0[];
extern u8 D_80815414_cj0[];
extern u8 D_80815458_cj0[];
