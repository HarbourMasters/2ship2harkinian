...
#define GREAT_BAY_COAST_STR { 0x834F, 0x838C, 0x815B, 0x8367, 0x8378, 0x8343, 0x82CC, 0x8A43, 0x8ADD }
#define ZORA_CAPE_STR { 0x835D, 0x815B, 0x8389, 0x82CC, 0x82DD, 0x82B3, 0x82AB }
#define SNOWHEAD_STR { 0x8358, 0x836D, 0x815B, 0x8377, 0x8362, 0x8368 }
#define MOUNTAIN_VILLAGE_STR { 0x8E52, 0x97A2 }
#define CLOCK_TOWN_STR { 0x834E, 0x838D, 0x8362, 0x834E, 0x835E, 0x8345, 0x8393 }
#define MILK_ROAD_STR { 0x837E, 0x838B, 0x834E, 0x838D, 0x815B, 0x8368 }
#define WOODFALL_STR { 0x8345, 0x8362, 0x8368, 0x8374, 0x8348, 0x815B, 0x838B }
#define SOUTHERN_SWAMP_STR { 0x8FC0, 0x926E }
#define IKANA_CANYON_STR { 0x8343, 0x834A, 0x815B, 0x8369, 0x8C6B, 0x924A }
#define STONE_TOWER_STR { 0x838D, 0x8362, 0x834E, 0x8372, 0x838B }
#define ENTRANCE_STR { 0x93FC, 0x82E8, 0x8CFB }
