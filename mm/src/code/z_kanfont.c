...
void Font_LoadChar(PlayState* play, u16 codePointIndex, s32 offset) {
    ...
    int fontIdx = Kanji_OffsetFromShiftJIS(codePointIndex);
    ...
    // Kanji_OffsetFromShiftJIS(codePointIndex), 0x80);
}
    ...
    while ((font->msgBuf.wchar[var_s1] != 0x500)) {
        ...
        if ((font->msgBuf.wchar[var_s1] != 0xA) && (font->msgBuf.wchar[var_s1] != 9) &&
            ...
            if (font->msgBuf.wchar[var_s1] == 0x20) {
                var_v0 = Kanji_OffsetFromShiftJIS(0x8140);
            } else {
                var_v0 = Kanji_OffsetFromShiftJIS(font->msgBuf.wchar[var_s1]);
            }
            // #region 2S2H [Port]
