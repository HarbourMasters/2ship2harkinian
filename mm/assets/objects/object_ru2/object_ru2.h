...
#define dgAdultRutoSkinGradientTex "__OTR__objects/object_ru2/gAdultRutoSkinGradientTex"
static const ALIGN_ASSET(2) char gAdultRutoSkinGradientTex[] = dgAdultRutoSkinGradientTex;
