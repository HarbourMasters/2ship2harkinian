...
Gfx gIKAxeInlineDL[] = {
    ...
    gsDPLoadTextureBlock_4b(gIKMetalTex2, G_IM_FMT_I, 32, 64, 0, G_TX_MIRROR | G_TX_WRAP, G_TX_MIRROR | G_TX_WRAP, 5, 6,
    ...
    gsDPLoadTextureBlock(gIKBlockPatternTex, G_IM_FMT_RGBA, G_IM_SIZ_16b, 16, 16, 0, G_TX_NOMIRROR | G_TX_WRAP,
    ...
    gsDPLoadTextureBlock(gIKJewelTex, G_IM_FMT_CI, G_IM_SIZ_8b, 16, 16, 0, G_TX_NOMIRROR | G_TX_CLAMP,
                         G_TX_NOMIRROR | G_TX_CLAMP, 4, 4, G_TX_NOLOD, G_TX_NOLOD),
