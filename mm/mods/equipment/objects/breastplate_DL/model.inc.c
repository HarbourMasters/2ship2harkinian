...
#define SPIRIT_METAL_SETUP                                                                                            \
    gsDPPipeSync(), gsDPSetTextureLUT(G_TT_NONE), gsSPTexture(0x0BB8, 0x0BB8, 0, G_TX_RENDERTILE, G_ON),              \
        gsDPLoadTextureBlock_4b(gIKMetalTex, G_IM_FMT_I, 32, 64, 0, G_TX_MIRROR | G_TX_WRAP, G_TX_MIRROR | G_TX_WRAP, \
                                5, 6, G_TX_NOLOD, G_TX_NOLOD),                                                        \
        gsDPSetCombineLERP(PRIMITIVE, ENVIRONMENT, TEXEL0, ENVIRONMENT, 0, 0, 0, PRIMITIVE, COMBINED, 0, SHADE, 0, 0, \
                           0, 0, COMBINED),                                                                           \
        gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_XLU_SURF2), gsSPClearGeometryMode(G_CULL_BACK),                \
...
Gfx gSpiritChestDL[] = {
    ...
    gsDPLoadTextureBlock(gIKChainMailTex, G_IM_FMT_RGBA, G_IM_SIZ_16b, 16, 16, 0, G_TX_NOMIRROR | G_TX_WRAP,
    ...
    gsDPLoadTextureBlock_4b(gIKMetalTex, G_IM_FMT_I, 32, 64, 0, G_TX_MIRROR | G_TX_WRAP, G_TX_MIRROR | G_TX_WRAP, 5, 6,
...
Gfx gSpiritHelmetMarkDL[] = {
    ...
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPLoadTextureBlock(gIKBigRivetTex, G_IM_FMT_IA, G_IM_SIZ_8b, 32, 32, 0, G_TX_NOMIRROR | G_TX_CLAMP,
    ...
    gsDPPipeSync(),
    gsDPLoadTextureBlock(gIKRivetTex, G_IM_FMT_IA, G_IM_SIZ_8b, 16, 16, 0, G_TX_NOMIRROR | G_TX_CLAMP,
