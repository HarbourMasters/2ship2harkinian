...
static const NeiItem sNeiItems[] = {
    ...
    { ITEM_ROD_ICE, PLAYER_IA_ROD_ICE, PLAYER_MODELGROUP_BGS, SLOT_ICE_ROD, AGE_REQ_NONE, (void*)gItemIconIceRodTex,
      Player_UpperAction_1, Player_InitIceRodIA, Randomizer_DrawIceRod, RG_ICE_ROD,
    ...
    { ITEM_ROD_LIGHT, PLAYER_IA_ROD_LIGHT, PLAYER_MODELGROUP_BGS, SLOT_LIGHT_ROD, AGE_REQ_NONE,
      (void*)gItemIconLightRodTex, Player_UpperAction_1, Player_InitLightRodIA, Randomizer_DrawLightRod, RG_LIGHT_ROD,
    ...
    { NEI_NO_ITEM, PLAYER_IA_UNUSED_5B, PLAYER_MODELGROUP_DEFAULT, NEI_NO_SLOT, AGE_REQ_NONE, NULL, func_8083485C,
      Player_InitDefaultIA, NULL, NEI_NO_RG, NULL, NULL, NULL },
    ...
    { ITEM_NET, PLAYER_IA_NET, PLAYER_MODELGROUP_DEFAULT, NEI_NO_SLOT, AGE_REQ_NONE, (void*)gItemIconNetTex,
      Player_UpperAction_Net, Player_InitDefaultIA, NULL, NEI_NO_RG,
    ...
    { ITEM_BOTTOMLESS_BOTTLE, PLAYER_IA_BOTTOMLESS_BOTTLE, PLAYER_MODELGROUP_DEFAULT, NEI_NO_SLOT, AGE_REQ_NONE,
      (void*)gItemIconBottomlessBottleTex, func_8083485C, Player_InitDefaultIA, NULL, NEI_NO_RG,
...
void ExtInv_DebugGiveAll(void) {
    for (size_t i = 0; i < NEI_ITEMS_COUNT; i++) {
        if (sNeiItems[i].item != NEI_NO_ITEM) {
            ExtInv_SetItemById((uint16_t)sNeiItems[i].item);
        }
    }
}
