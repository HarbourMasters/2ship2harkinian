...
const std::vector<FlagTable> flagTables = {
    ...
    { "Week Event Reg",
      WEEK_EVENT_REG,
      {
          ...
          { CYCLE_RESET, WEEKEVENTREG_SHARP_HOSTILE_CONVERSATION, "Activated Sharp" },
          { CYCLE_RESET, WEEKEVENTREG_IKANA_SPRING_RESTORED, "Water Raised in Ikana Canyon" },
          ...
          { CYCLE_RESET, WEEKEVENTREG_POSTMAN_CHECKED_SOUTH_UPPER_CLOCKTOWN, "Postman Checked Postbox 1: 9:30 AM" },
          { CYCLE_RESET, WEEKEVENTREG_POSTMAN_CHECKED_NORTH_CLOCKTOWN, "Postman Checked Postbox 2: 10:03 AM" },
          { CYCLE_RESET, WEEKEVENTREG_POSTMAN_CHECKED_EAST_UPPER_CLOCKTOWN, "Postman Checked Postbox 3: 10:35 AM" },
          { CYCLE_RESET, WEEKEVENTREG_POSTMAN_CHECKED_EAST_LOWER_CLOCKTOWN, "Postman Checked Postbox 4: 10:52 AM" },
          { CYCLE_RESET, WEEKEVENTREG_POSTMAN_CHECKED_SOUTH_LOWER_CLOCKTOWN, "Postman Checked Postbox 5: 11:25 AM" },
          { CYCLE_RESET, WEEKEVENTREG_LETTER_TO_KAFEI_SCHEDULED_DAY_2, "Postman Scheduled to Deliver Letter to Kafei (Day 2)" },
          { CYCLE_RESET, WEEKEVENTREG_LETTER_TO_KAFEI_SCHEDULED_DAY_3, "Postman Scheduled to Deliver Letter to Kafei (Day 3)" },
          ...
          { CYCLE_RESET, WEEKEVENTREG_LETTER_TO_KAFEI_SCHEDULED_TODAY, "Letter to Kafei Scheduled Today" },
          { SCENE_RESET, WEEKEVENTREG_HIT_LAUNDRY_POOL_BELL, "Hit Kafei's Bell" },
          { CYCLE_RESET, WEEKEVENTREG_KAFEI_ENTRUSTED_LINK, "Obtained Pendant of Memories" },
          ...
          { CYCLE_RESET, WEEKEVENTREG_CAN_USE_CURIOSITY_SHOP_PEEPHOLE, "Can use Curiosity Shop Peephole" },
          ...
          { CYCLE_RESET, WEEKEVENTREG_DEKU_TALKED_TO_BOMBER_2, "Spoke to Bomber #2 As Deku Once" },
          { CYCLE_RESET, WEEKEVENTREG_DEKU_TALKED_TO_BOMBER_3, "Spoke to Bomber #3 As Deku Once" },
          { CYCLE_RESET, WEEKEVENTREG_DEKU_TALKED_TO_BOMBER_4, "Spoke to Bomber #4 As Deku Once" },
          { CYCLE_RESET, WEEKEVENTREG_DEKU_TALKED_TO_BOMBER_5, "Spoke to Bomber #5 As Deku Once" },
          ...
          { CYCLE_RESET, WEEKEVENTREG_TALKED_TO_CANYON_GUARD_WITH_NO_MASK, "Spoke to Guy Outside Ikana Hill" },
          { CYCLE_RESET, WEEKEVENTREG_TALKED_TO_CANYON_GUARD_WITH_CAPTAINS_HAT, "Spoke to Guy Outside Ikana Hill with Captain's Hat" },
          ...
          { SCENE_RESET, WEEKEVENTREG_PLAYING_SWORDSMAN_MINIGAME, "Playing Swordsman Minigame" },
          ...
          { CYCLE_RESET, WEEKEVENTREG_TALKED_TO_BOMBERS_GUARD, "Spoke to Bomber Guarding Passage" },
          ...
          { CYCLE_RESET, WEEKEVENTREG_POSTMAN_RECEIVED_LETTER_TO_KAFEI, "Letter to Kafei Picked up by Postman" },
          ...
          { CYCLE_RESET, WEEKEVENTREG_LETTER_TO_KAFEI_SENT_IN_TIME, "Sent Letter to Kafei On Time" },
          { CYCLE_RESET, WEEKEVENTREG_LETTER_TO_KAFEI_SENT_LATE, "Sent Letter to Kafei Late" },
