...
#define CVAR_NAME_SHOW_LOGIC CVAR_TRACKER_CHECK("OnlyShowChecksInLogic")
#define CVAR_NAME_HIDE_COLLECTED CVAR_TRACKER_CHECK("HideCollectedChecks")
#define CVAR_NAME_HIDE_SKIPPED CVAR_TRACKER_CHECK("HideSkippedChecks")
#define CVAR_NAME_SCROLL_TO_SCENE CVAR_TRACKER_CHECK("ScrollToCurrentScene")
#define CVAR_NAME_TRACKER_OPACITY CVAR_TRACKER_CHECK("Opacity")
#define CVAR_NAME_TRACKER_SCALE CVAR_TRACKER_CHECK("Scale")
#define CVAR_NAME_SHOW_CURRENT_SCENE CVAR_TRACKER_CHECK("ShowCurrentScene")
