...
// 5.0.0 (keaton grass shuffle): deliberately NOT extended with CAN_USE_EXT_SWORD — it tests the
// native equipped sword tier (Razor+) plus the great spin attack, which no ext sword can stand in for.
