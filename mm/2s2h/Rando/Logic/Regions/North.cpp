...
static RegisterShipInitFunc initFunc([]() {
    ...
    Regions[RR_PATH_TO_GORON_VILLAGE] = RandoRegion{ .sceneId = SCENE_17SETUGEN,
        .checks = {
            ...
            CHECK(RC_TWIN_ISLANDS_SPRING_GRASS_01, CHECK_WEEKEVENTREG(WEEKEVENTREG_CLEARED_SNOWHEAD_TEMPLE)),
            CHECK(RC_TWIN_ISLANDS_SPRING_GRASS_02, CHECK_WEEKEVENTREG(WEEKEVENTREG_CLEARED_SNOWHEAD_TEMPLE)),
            CHECK(RC_TWIN_ISLANDS_SPRING_GRASS_03, CHECK_WEEKEVENTREG(WEEKEVENTREG_CLEARED_SNOWHEAD_TEMPLE)),
            CHECK(RC_TWIN_ISLANDS_SPRING_GRASS_04, CHECK_WEEKEVENTREG(WEEKEVENTREG_CLEARED_SNOWHEAD_TEMPLE)),
            CHECK(RC_TWIN_ISLANDS_SPRING_GRASS_05, CHECK_WEEKEVENTREG(WEEKEVENTREG_CLEARED_SNOWHEAD_TEMPLE)),
            CHECK(RC_TWIN_ISLANDS_SPRING_GRASS_06, CHECK_WEEKEVENTREG(WEEKEVENTREG_CLEARED_SNOWHEAD_TEMPLE)),
            CHECK(RC_TWIN_ISLANDS_SPRING_GRASS_07, CHECK_WEEKEVENTREG(WEEKEVENTREG_CLEARED_SNOWHEAD_TEMPLE)),
            CHECK(RC_TWIN_ISLANDS_SPRING_GRASS_08, CHECK_WEEKEVENTREG(WEEKEVENTREG_CLEARED_SNOWHEAD_TEMPLE)),
            CHECK(RC_TWIN_ISLANDS_SPRING_GRASS_09, CHECK_WEEKEVENTREG(WEEKEVENTREG_CLEARED_SNOWHEAD_TEMPLE)),
            CHECK(RC_TWIN_ISLANDS_SPRING_GRASS_10, CHECK_WEEKEVENTREG(WEEKEVENTREG_CLEARED_SNOWHEAD_TEMPLE)),
            CHECK(RC_TWIN_ISLANDS_SPRING_GRASS_11, CHECK_WEEKEVENTREG(WEEKEVENTREG_CLEARED_SNOWHEAD_TEMPLE)),
            CHECK(RC_TWIN_ISLANDS_SPRING_GRASS_12, CHECK_WEEKEVENTREG(WEEKEVENTREG_CLEARED_SNOWHEAD_TEMPLE)),
        },
        .exits = { //     TO                                     FROM
