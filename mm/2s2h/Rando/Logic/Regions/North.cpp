...
static RegisterShipInitFunc initFunc([]() {
    ...
    Regions[RR_MOUNTAIN_VILLAGE] = RandoRegion{ .sceneId = SCENE_10YUKIYAMANOMURA,
        .checks = {
            ...
            CHECK(RC_MOUNTAIN_VILLAGE_FROG_CHOIR,                   HAS_ITEM(ITEM_MASK_DON_GERO) && RANDO_EVENTS[RE_CLEARED_SNOWHEAD_TEMPLE] && RANDO_EVENTS[RE_ACCESS_FROG_CYAN] && RANDO_EVENTS[RE_ACCESS_FROG_BLUE] && RANDO_EVENTS[RE_ACCESS_FROG_WHITE] && RANDO_EVENTS[RE_ACCESS_FROG_PINK]),
    ...
    Regions[RR_PATH_TO_GORON_VILLAGE] = RandoRegion{ .sceneId = SCENE_17SETUGEN,
        .checks = {
            ...
            CHECK(RC_TWIN_ISLANDS_UNDERWATER_CHEST_01,    CAN_BE_ZORA && CAN_USE_ABILITY(RI_ABILITY_SWIM) && RANDO_EVENTS[RE_CLEARED_SNOWHEAD_TEMPLE]),
            CHECK(RC_TWIN_ISLANDS_UNDERWATER_CHEST_02,    CAN_BE_ZORA && CAN_USE_ABILITY(RI_ABILITY_SWIM) && RANDO_EVENTS[RE_CLEARED_SNOWHEAD_TEMPLE]),
            CHECK(RC_TWIN_ISLANDS_FREESTANDING_RUPEE_01, CAN_BE_ZORA && CAN_USE_ABILITY(RI_ABILITY_SWIM) && RANDO_EVENTS[RE_CLEARED_SNOWHEAD_TEMPLE]),
            CHECK(RC_TWIN_ISLANDS_FREESTANDING_RUPEE_02, CAN_BE_ZORA && CAN_USE_ABILITY(RI_ABILITY_SWIM) && RANDO_EVENTS[RE_CLEARED_SNOWHEAD_TEMPLE]),
            CHECK(RC_TWIN_ISLANDS_FREESTANDING_RUPEE_03, CAN_BE_ZORA && CAN_USE_ABILITY(RI_ABILITY_SWIM) && RANDO_EVENTS[RE_CLEARED_SNOWHEAD_TEMPLE]),
            CHECK(RC_TWIN_ISLANDS_FREESTANDING_RUPEE_04, CAN_BE_ZORA && CAN_USE_ABILITY(RI_ABILITY_SWIM) && RANDO_EVENTS[RE_CLEARED_SNOWHEAD_TEMPLE]),
