...
static RegisterShipInitFunc initFunc([]() {
    ...
    Regions[RR_IKANA_CANYON_LOWER] = RandoRegion{ .name = "Lower", .sceneId = SCENE_IKANA,
        ...
        .exits = { //     TO                                         FROM
            ...
            */
            ...
            EXIT(ENTRANCE(SECRET_SHRINE, 0),                ENTRANCE(IKANA_CANYON, 12), CAN_USE_ABILITY(RI_ABILITY_SWIM)),
            EXIT(ENTRANCE(SOUTHERN_SWAMP_POISONED, 9),               ONE_WAY_EXIT, CAN_USE_ABILITY(RI_ABILITY_SWIM)),
        },
        .connections = {
            CONNECTION(RR_IKANA_CANYON_UPPER, HAS_ITEM(ITEM_HOOKSHOT) && CAN_USE_MAGIC_ARROW(ICE)),
            CONNECTION(RR_IKANA_CANYON_GROTTO, CAN_USE_ABILITY(RI_ABILITY_SWIM)), // TODO: Grotto mapping
        },
        .events = {
    ...
    Regions[RR_SECRET_SHRINE] = RandoRegion{ .sceneId = SCENE_RANDOM,
        .checks = {
            ...
            CHECK(RC_SECRET_SHRINE_POT_04, CAN_BE_ZORA || CAN_USE_ABILITY(RI_ABILITY_SWIM)),
            CHECK(RC_SECRET_SHRINE_POT_05, CAN_BE_ZORA || CAN_USE_ABILITY(RI_ABILITY_SWIM)),
            CHECK(RC_SECRET_SHRINE_POT_06, CAN_BE_ZORA || CAN_USE_ABILITY(RI_ABILITY_SWIM)),
            CHECK(RC_SECRET_SHRINE_POT_07, CAN_BE_ZORA || CAN_USE_ABILITY(RI_ABILITY_SWIM)),
            CHECK(RC_SECRET_SHRINE_POT_08, CAN_BE_ZORA || CAN_USE_ABILITY(RI_ABILITY_SWIM)),
            CHECK(RC_SECRET_SHRINE_POT_09, CAN_BE_ZORA || CAN_USE_ABILITY(RI_ABILITY_SWIM)),
        },
        .connections = {
