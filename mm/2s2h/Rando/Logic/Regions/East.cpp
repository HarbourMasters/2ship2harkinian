...
static RegisterShipInitFunc initFunc([]() {
    ...
    Regions[RR_SECRET_SHRINE] = RandoRegion{ .sceneId = SCENE_RANDOM,
        .checks = {
            ...
            CHECK(RC_SECRET_SHRINE_POT_04, CAN_BE_ZORA || CAN_USE_ABILITY(SWIM)),
            CHECK(RC_SECRET_SHRINE_POT_05, CAN_BE_ZORA || CAN_USE_ABILITY(SWIM)),
            CHECK(RC_SECRET_SHRINE_POT_06, CAN_BE_ZORA || CAN_USE_ABILITY(SWIM)),
            CHECK(RC_SECRET_SHRINE_POT_07, CAN_BE_ZORA || CAN_USE_ABILITY(SWIM)),
            CHECK(RC_SECRET_SHRINE_POT_08, CAN_BE_ZORA || CAN_USE_ABILITY(SWIM)),
            CHECK(RC_SECRET_SHRINE_POT_09, CAN_BE_ZORA || CAN_USE_ABILITY(SWIM)),
        },
        .connections = {
