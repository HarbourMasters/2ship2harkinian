...
static RegisterShipInitFunc initFunc([]() {
    ...
    Regions[RR_TREASURE_SHOP] = RandoRegion{ .sceneId = SCENE_TAKARAYA,
        .checks = {
            CHECK(RC_CLOCK_TOWN_EAST_TREAUSRE_CHEST_GAME_DEKU,  CAN_BE_DEKU), // add can_afford?
            CHECK(RC_CLOCK_TOWN_EAST_TREAUSRE_CHEST_GAME_GORON, CAN_BE_GORON),
            CHECK(RC_CLOCK_TOWN_EAST_TREAUSRE_CHEST_GAME_HUMAN, true), // can be human
            CHECK(RC_CLOCK_TOWN_EAST_TREAUSRE_CHEST_GAME_ZORA,  CAN_BE_ZORA),
        },
        .exits = { //     TO                                         FROM
