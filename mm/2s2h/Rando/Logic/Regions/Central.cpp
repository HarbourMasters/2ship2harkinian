...
static RegisterShipInitFunc initFunc([]() {
    ...
    Regions[RR_CLOCK_TOWN_LAUNDRY] = RandoRegion{ .sceneId = SCENE_ALLEY,
        .checks = {
            ...
            CHECK(RC_CLOCK_TOWN_LAUNDRY_FREESTANDING_RUPEE_01,  IS_NIGHT2()),
            CHECK(RC_CLOCK_TOWN_LAUNDRY_FREESTANDING_RUPEE_02,  IS_NIGHT2()),
            CHECK(RC_CLOCK_TOWN_LAUNDRY_FREESTANDING_RUPEE_03,  IS_NIGHT2()),
    ...
    Regions[RR_HONEY_AND_DARLING] = RandoRegion{ .sceneId = SCENE_BOWLING,
        .checks = {
            CHECK(RC_CLOCK_TOWN_EAST_HONEY_DARLING_ALL_DAYS, CAN_AFFORD(RC_CLOCK_TOWN_EAST_HONEY_DARLING_ALL_DAYS) && HAS_ITEM(ITEM_BOW) && RANDO_EVENTS[RE_HONEY_DARLING_REWARD_DAY1] && RANDO_EVENTS[RE_HONEY_DARLING_REWARD_DAY2] && RANDO_EVENTS[RE_HONEY_DARLING_REWARD_DAY3]),
            CHECK(RC_CLOCK_TOWN_EAST_HONEY_DARLING_ANY_DAY, CAN_AFFORD(RC_CLOCK_TOWN_EAST_HONEY_DARLING_ANY_DAY) && (RANDO_EVENTS[RE_HONEY_DARLING_REWARD_DAY1] || RANDO_EVENTS[RE_HONEY_DARLING_REWARD_DAY2] || RANDO_EVENTS[RE_HONEY_DARLING_REWARD_DAY3])),
        },
        .exits = { //     TO                                         FROM
    ...
    Regions[RR_SWORDSMAN_SCHOOL] = RandoRegion{ .sceneId = SCENE_DOUJOU,
        .checks = {
            CHECK(RC_SWORDSMAN_SCHOOL_PIECE_OF_HEART, CAN_USE_HUMAN_SWORD && CAN_AFFORD(RC_SWORDSMAN_SCHOOL_PIECE_OF_HEART) && BEFORE(TIME_NIGHT3_PM_11_00)),
    ...
    Regions[RR_TOWN_DEKU_PLAYGROUND] = RandoRegion{ .sceneId = SCENE_DEKUTES,
        .checks = {
            CHECK(RC_DEKU_PLAYGROUND_ALL_DAYS, CAN_BE_DEKU && CAN_AFFORD(RC_DEKU_PLAYGROUND_ALL_DAYS) && RANDO_EVENTS[RE_DEKU_PLAYGROUND_1] && RANDO_EVENTS[RE_DEKU_PLAYGROUND_2] && RANDO_EVENTS[RE_DEKU_PLAYGROUND_3]),
            CHECK(RC_DEKU_PLAYGROUND_ANY_DAY, CAN_BE_DEKU && CAN_AFFORD(RC_DEKU_PLAYGROUND_ANY_DAY) && (RANDO_EVENTS[RE_DEKU_PLAYGROUND_1] || RANDO_EVENTS[RE_DEKU_PLAYGROUND_2] || RANDO_EVENTS[RE_DEKU_PLAYGROUND_3])),
        ...
        .events = {
            EVENT(RE_DEKU_PLAYGROUND_1, BETWEEN(TIME_DAY1_AM_06_00, TIME_NIGHT1_AM_12_00)),
            EVENT(RE_DEKU_PLAYGROUND_2, BETWEEN(TIME_DAY2_AM_06_00, TIME_NIGHT2_AM_12_00)),
            EVENT(RE_DEKU_PLAYGROUND_3, BETWEEN(TIME_DAY3_AM_06_00, TIME_NIGHT3_AM_12_00)),
        },
    };
