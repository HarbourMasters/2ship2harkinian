...
static RegisterShipInitFunc initFunc([]() {
    ...
    Regions[RR_INN] = RandoRegion{ .sceneId = SCENE_YADOYA,
        ...
        .events = {
            ...
            EVENT(RE_DELIVER_PENDANT, Flags_GetRandoInf(RANDO_INF_OBTAINED_PENDANT_OF_MEMORIES) && (CLOCK_DAY2() || CLOCK_NIGHT2() || CLOCK_DAY3()) && (BETWEEN(TIME_DAY2_AM_06_00, TIME_NIGHT2_PM_09_00) || BETWEEN(TIME_DAY3_AM_06_00, TIME_DAY3_AM_11_30))),
        },
        .timeStayRestrictions = {
