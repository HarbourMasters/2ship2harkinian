...
static RegisterShipInitFunc initFunc([]() {
    ...
    Regions[RR_CLOCK_TOWN_LAUNDRY] = RandoRegion{ .sceneId = SCENE_ALLEY,
        ...
        .events = {
            EVENT(RE_MEET_KAFEI, Flags_GetRandoInf(RANDO_INF_OBTAINED_LETTER_TO_KAFEI) && SECOND_DAY() && BETWEEN(TIME_DAY2_PM_02_00, TIME_NIGHT2_PM_10_00)),
        },
    };
    ...
    Regions[RR_CURIOSITY_SHOP_BACK] = RandoRegion{ .name = "Back", .sceneId = SCENE_AYASHIISHOP,
        .checks = {
            CHECK(RC_KAFEIS_HIDEOUT_KEATON_MASK, FINAL_DAY() && BETWEEN(TIME_DAY3_PM_01_00, TIME_NIGHT3_PM_10_00)),
            CHECK(RC_KAFEIS_HIDEOUT_LETTER_TO_MAMA, FINAL_DAY() && BETWEEN(TIME_DAY3_PM_01_00, TIME_NIGHT3_PM_10_00)),
            CHECK(RC_KAFEIS_HIDEOUT_PENDANT_OF_MEMORIES, Flags_GetRandoInf(RANDO_INF_OBTAINED_LETTER_TO_KAFEI) && SECOND_DAY() && BETWEEN(TIME_DAY2_PM_02_00, TIME_NIGHT2_PM_10_00)),
        },
        .exits = { //     TO                                         FROM
    ...
    Regions[RR_INN] = RandoRegion{ .sceneId = SCENE_YADOYA,
        .checks = {
            CHECK(RC_STOCK_POT_INN_COUPLES_MASK, HAS_ITEM(ITEM_MASK_KAFEIS_MASK) && Flags_GetRandoInf(RANDO_INF_OBTAINED_PENDANT_OF_MEMORIES) && CLOCK_NIGHT3() && RANDO_EVENTS[RE_RETRIEVE_SUN_MASK] && AFTER(TIME_NIGHT3_AM_04_00)),
            ...
            CHECK(RC_STOCK_POT_INN_ROOM_KEY, CLOCK_DAY1() && BETWEEN(TIME_DAY1_PM_01_45, TIME_DAY1_PM_04_00)),
        ...
        .events = {
            ...
            EVENT(RE_SETUP_MEET_ANJU, HAS_ITEM(ITEM_MASK_KAFEIS_MASK) && FIRST_DAY() && BETWEEN(TIME_DAY1_PM_01_45, TIME_NIGHT1_PM_09_00)),
            EVENT(RE_ANJU_MIDNIGHT_MEETING, RANDO_EVENTS[RE_SETUP_MEET_ANJU] && CLOCK_NIGHT1() && BETWEEN(TIME_NIGHT1_AM_12_00, TIME_DAY2_AM_06_00) && (Flags_GetRandoInf(RANDO_INF_OBTAINED_ROOM_KEY) || CAN_BE_DEKU)),
            EVENT(RE_DELIVER_PENDANT, Flags_GetRandoInf(RANDO_INF_OBTAINED_PENDANT_OF_MEMORIES) && (SECOND_DAY() || CLOCK_DAY3()) && (BETWEEN(TIME_DAY2_AM_06_00, TIME_NIGHT2_PM_09_00) || BETWEEN(TIME_DAY3_AM_06_00, TIME_DAY3_AM_11_30))),
        },
        .timeStayRestrictions = {
    ...
    Regions[RR_MAYOR_RESIDENCE] = RandoRegion{ .sceneId = SCENE_SONCHONOIE,
        .checks = {
            CHECK(RC_MAYORS_OFFICE_PIECE_OF_HEART, HAS_ITEM(ITEM_MASK_COUPLE) && ((FIRST_DAY() && BETWEEN(TIME_DAY1_AM_10_00, TIME_NIGHT1_PM_08_00)) || (SECOND_DAY() && BETWEEN(TIME_DAY2_AM_10_00, TIME_NIGHT2_PM_08_00)))),
            CHECK(RC_MAYORS_OFFICE_KAFEIS_MASK, (FIRST_DAY() && BETWEEN(TIME_DAY1_AM_10_00, TIME_NIGHT1_PM_08_00)) || (SECOND_DAY() && BETWEEN(TIME_DAY2_AM_10_00, TIME_NIGHT2_PM_08_00)))
        },
        .exits = { //     TO                                         FROM
    ...
    Regions[RR_MILK_BAR] = RandoRegion{ .sceneId = SCENE_MILK_BAR,
        .checks = {
            ...
            CHECK(RC_MILK_BAR_MADAME_AROMA, HAS_ITEM(ITEM_MASK_KAFEIS_MASK) && Flags_GetRandoInf(RANDO_INF_OBTAINED_LETTER_TO_MAMA) && CLOCK_NIGHT3() && (BETWEEN(TIME_NIGHT3_PM_06_00, TIME_NIGHT3_PM_09_00) || AFTER(TIME_NIGHT3_PM_10_00))),
            CHECK(RC_MILK_BAR_PURCHASE_CHATEAU, CAN_AFFORD(RC_MILK_BAR_PURCHASE_CHATEAU) && HAS_ITEM(ITEM_MASK_ROMANI) && IS_NIGHT() && (BETWEEN(TIME_NIGHT1_PM_10_00, TIME_DAY2_AM_06_00) || BETWEEN(TIME_NIGHT2_PM_10_00, TIME_DAY3_AM_06_00) || BETWEEN(TIME_NIGHT3_PM_06_00, TIME_NIGHT3_PM_09_00) || AFTER(TIME_NIGHT3_PM_10_00))),
            CHECK(RC_MILK_BAR_PURCHASE_MILK, CAN_AFFORD(RC_MILK_BAR_PURCHASE_MILK) && HAS_ITEM(ITEM_MASK_ROMANI) && IS_NIGHT() && (BETWEEN(TIME_NIGHT1_PM_10_00, TIME_DAY2_AM_06_00) || BETWEEN(TIME_NIGHT2_PM_10_00, TIME_DAY3_AM_06_00) || BETWEEN(TIME_NIGHT3_PM_06_00, TIME_NIGHT3_PM_09_00) || AFTER(TIME_NIGHT3_PM_10_00))),
        },
        .exits = { //     TO                                         FROM
    ...
    Regions[RR_POST_OFFICE] = RandoRegion{ .sceneId = SCENE_POSTHOUSE,
        .checks = {
            ...
            CHECK(RC_CLOCK_TOWN_WEST_POSTMAN_MINIGAME, HAS_ITEM(ITEM_MASK_BUNNY) && ((FIRST_DAY() && BETWEEN(TIME_DAY1_PM_03_00, TIME_NIGHT1_AM_12_00)) || (CLOCK_NIGHT2() && Flags_GetRandoInf(RANDO_INF_OBTAINED_LETTER_TO_KAFEI) && BETWEEN(TIME_NIGHT2_PM_06_00, TIME_NIGHT2_AM_12_00)))),
        },
        .exits = { //     TO                                         FROM
    ...
    Regions[RR_SWORDSMAN_SCHOOL] = RandoRegion{ .sceneId = SCENE_DOUJOU,
        .checks = {
            ...
            CHECK(RC_SWORDSMAN_SCHOOL_POT_01, CAN_USE_HUMAN_SWORD && CLOCK_NIGHT3() && AFTER(TIME_NIGHT3_AM_12_00)),
            CHECK(RC_SWORDSMAN_SCHOOL_POT_02, CAN_USE_HUMAN_SWORD && CLOCK_NIGHT3() && AFTER(TIME_NIGHT3_AM_12_00)),
            CHECK(RC_SWORDSMAN_SCHOOL_POT_03, CAN_USE_HUMAN_SWORD && CLOCK_NIGHT3() && AFTER(TIME_NIGHT3_AM_12_00)),
            CHECK(RC_SWORDSMAN_SCHOOL_POT_04, CAN_USE_HUMAN_SWORD && CLOCK_NIGHT3() && AFTER(TIME_NIGHT3_AM_12_00)),
            CHECK(RC_SWORDSMAN_SCHOOL_POT_05, CAN_USE_HUMAN_SWORD && CLOCK_NIGHT3() && AFTER(TIME_NIGHT3_AM_12_00)),
        },
        .exits = { //     TO                                         FROM
