...
static RegisterShipInitFunc initFunc([]() {
    ...
    Regions[RR_TREASURE_SHOP] = RandoRegion{ .sceneId = SCENE_TAKARAYA,
        .checks = {
            CHECK(RC_CLOCK_TOWN_EAST_TREASURE_CHEST_GAME_DEKU,  CAN_BE_DEKU && (FIRST_DAY() || SECOND_DAY() || CLOCK_DAY3()) && BEFORE(TIME_NIGHT3_PM_06_00)),
            CHECK(RC_CLOCK_TOWN_EAST_TREASURE_CHEST_GAME_GORON, CAN_BE_GORON && (FIRST_DAY() || SECOND_DAY() || CLOCK_DAY3()) && BEFORE(TIME_NIGHT3_PM_06_00)),
            CHECK(RC_CLOCK_TOWN_EAST_TREASURE_CHEST_GAME_HUMAN, (FIRST_DAY() || SECOND_DAY() || CLOCK_DAY3()) && BEFORE(TIME_NIGHT3_PM_06_00)), // can be human
            CHECK(RC_CLOCK_TOWN_EAST_TREASURE_CHEST_GAME_ZORA,  CAN_BE_ZORA && (FIRST_DAY() || SECOND_DAY() || CLOCK_DAY3()) && BEFORE(TIME_NIGHT3_PM_06_00)),
        },
        .exits = { //     TO                                         FROM
