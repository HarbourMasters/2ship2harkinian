...
static RegisterShipInitFunc initFunc([]() {
    ...
    Regions[RR_CURIOSITY_SHOP_FRONT] = RandoRegion{ .name = "Front", .sceneId = SCENE_AYASHIISHOP,
        .checks = {
            ...
            CHECK(RC_CURIOSITY_SHOP_SEAHORSE, CAN_AFFORD(RC_CURIOSITY_SHOP_SEAHORSE) && HAS_BOTTLE_ITEM(ITEM_BOTTLE)),
            CHECK(RC_CURIOSITY_SHOP_REFILL_GOLD_DUST, CAN_AFFORD(RC_CURIOSITY_SHOP_REFILL_GOLD_DUST) && HAS_BOTTLE_ITEM(ITEM_BOTTLE)),
            CHECK(RC_CURIOSITY_SHOP_REFILL_CHATEAU, CAN_AFFORD(RC_CURIOSITY_SHOP_REFILL_CHATEAU) && HAS_BOTTLE_ITEM(ITEM_BOTTLE)),
        },
        .exits = { //     TO                                         FROM
