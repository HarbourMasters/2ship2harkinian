...
static RegisterShipInitFunc initFunc([]() {
    ...
    Regions[RR_CLOCK_TOWN_LAUNDRY] = RandoRegion{ .sceneId = SCENE_ALLEY,
        ...
        .events = {
            EVENT(RE_MEET_KAFEI, Flags_GetRandoInf(RANDO_INF_OBTAINED_LETTER_TO_KAFEI) && (CLOCK_DAY2() || CLOCK_NIGHT2()) && BETWEEN(TIME_DAY2_PM_02_00, TIME_NIGHT2_PM_10_00)),
        },
    };
    ...
    Regions[RR_CURIOSITY_SHOP_BACK] = RandoRegion{ .name = "Back", .sceneId = SCENE_AYASHIISHOP,
        .checks = {
            CHECK(RC_KAFEIS_HIDEOUT_KEATON_MASK, (CLOCK_DAY3() || CLOCK_NIGHT3()) && BETWEEN(TIME_DAY3_PM_01_00, TIME_NIGHT3_PM_10_00)),
            CHECK(RC_KAFEIS_HIDEOUT_LETTER_TO_MAMA, (CLOCK_DAY3() || CLOCK_NIGHT3()) && BETWEEN(TIME_DAY3_PM_01_00, TIME_NIGHT3_PM_10_00)),
            CHECK(RC_KAFEIS_HIDEOUT_PENDANT_OF_MEMORIES, Flags_GetRandoInf(RANDO_INF_OBTAINED_LETTER_TO_KAFEI) && (CLOCK_DAY2() || CLOCK_NIGHT2()) && BETWEEN(TIME_DAY2_PM_02_00, TIME_NIGHT2_PM_10_00)),
        },
        .exits = { //     TO                                         FROM
    ...
    Regions[RR_INN] = RandoRegion{ .sceneId = SCENE_YADOYA,
        ...
        .events = {
            ...
            EVENT(RE_SETUP_MEET_ANJU, HAS_ITEM(ITEM_MASK_KAFEIS_MASK) && CLOCK_DAY1() && BETWEEN(TIME_DAY1_PM_01_45, TIME_NIGHT1_PM_09_00)),
