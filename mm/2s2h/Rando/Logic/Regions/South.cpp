...
static RegisterShipInitFunc initFunc([]() {
    ...
    Regions[RR_SOUTHERN_SWAMP_NORTH] = RandoRegion{ .name = "North Section", .sceneId = SCENE_20SICHITAI,
        ...
        .exits = { //     TO                                         FROM
            ...
            EXIT(ENTRANCE(MAGIC_HAGS_POTION_SHOP, 0),       ENTRANCE(SOUTHERN_SWAMP_POISONED, 5), CAN_BE_DEKU || CAN_USE_ABILITY(RI_ABILITY_SWIM)),
            EXIT(ENTRANCE(WOODS_OF_MYSTERY, 0),             ENTRANCE(SOUTHERN_SWAMP_POISONED, 7), CAN_BE_DEKU || CAN_USE_ABILITY(RI_ABILITY_SWIM)),
        },
        .connections = {
    ...
    Regions[RR_WOODFALL] = RandoRegion{ .sceneId = SCENE_21MITURINMAE,
        ...
        .exits = { //     TO                                         FROM
            ...
            EXIT(ENTRANCE(WOODFALL_TEMPLE, 0),              ENTRANCE(WOODFALL, 1), CanAccessDungeon(DUNGEON_INDEX_WOODFALL_TEMPLE)),
