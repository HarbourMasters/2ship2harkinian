...
static RegisterShipInitFunc initFunc([]() {
    ...
    Regions[RR_SOUTHERN_SWAMP_NORTH] = RandoRegion{ .name = "North Section", .sceneId = SCENE_20SICHITAI,
        .checks = {
            ...
            CHECK(RC_SOUTHERN_SWAMP_CLEARED_GRASS_31, CHECK_WEEKEVENTREG(WEEKEVENTREG_CLEARED_WOODFALL_TEMPLE)),
            CHECK(RC_SOUTHERN_SWAMP_CLEARED_GRASS_32, CHECK_WEEKEVENTREG(WEEKEVENTREG_CLEARED_WOODFALL_TEMPLE)),
            CHECK(RC_SOUTHERN_SWAMP_CLEARED_GRASS_33, CHECK_WEEKEVENTREG(WEEKEVENTREG_CLEARED_WOODFALL_TEMPLE)),
            CHECK(RC_SOUTHERN_SWAMP_CLEARED_GRASS_34, CHECK_WEEKEVENTREG(WEEKEVENTREG_CLEARED_WOODFALL_TEMPLE)),
            ...
            CHECK(RC_SOUTHERN_SWAMP_POISON_GRASS_31, true),
            CHECK(RC_SOUTHERN_SWAMP_POISON_GRASS_32, true),
            CHECK(RC_SOUTHERN_SWAMP_POISON_GRASS_33, true),
            CHECK(RC_SOUTHERN_SWAMP_POISON_GRASS_34, true),
        },
        .exits = { //     TO                                         FROM
