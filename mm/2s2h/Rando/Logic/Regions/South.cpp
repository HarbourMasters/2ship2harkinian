...
static RegisterShipInitFunc initFunc([]() {
    ...
    Regions[RR_WOODFALL] = RandoRegion{ .sceneId = SCENE_21MITURINMAE,
        ...
        .exits = { //     TO                                         FROM
            ...
            EXIT(ENTRANCE(WOODFALL_TEMPLE, 0),              ENTRANCE(WOODFALL, 1), (!RANDO_SAVE_OPTIONS[RO_ACCESS_DUNGEONS_REQUIRES_SONG] || CAN_PLAY_SONG(SONATA)) && 
(!RANDO_SAVE_OPTIONS[RO_ACCESS_DUNGEONS_REQUIRES_FORM] || CAN_BE_DEKU)),
