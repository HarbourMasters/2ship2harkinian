...
static RegisterShipInitFunc initFunc([]() {
    ...
    Regions[RR_SOUTHERN_SWAMP_SOUTH] = RandoRegion{ .name = "South Section", .sceneId = SCENE_20SICHITAI,
        ...
        .connections = {
            CONNECTION(RR_SOUTHERN_SWAMP_NEAR_TOURIST, (RANDO_EVENTS[RE_SOUTHERN_SWAMP_KILL_OCTOROK] || RANDO_EVENTS[RE_CLEARED_WOODFALL_TEMPLE])),
            CONNECTION(RR_SOUTHERN_SWAMP_NEAR_WOODS, (RANDO_EVENTS[RE_SOUTHERN_SWAMP_KILL_OCTOROK] || RANDO_EVENTS[RE_CLEARED_WOODFALL_TEMPLE])),
