...
static RegisterShipInitFunc initFunc([]() {
    ...
    Regions[RR_GREAT_BAY_COAST] = RandoRegion{ .sceneId = SCENE_30GYOSON,
        .checks = {
            CHECK(RC_GREAT_BAY_COAST_FISHERMAN_MINIGAME, RANDO_EVENTS[RE_CLEARED_GREAT_BAY_TEMPLE] && (HAS_ITEM(ITEM_HOOKSHOT) || CAN_USE_MAGIC_ARROW(ICE)) && CAN_USE_ABILITY(RI_ABILITY_SWIM)),
            CHECK(RC_GREAT_BAY_COAST_OWL_STATUE, (CAN_USE_SWORD && CAN_USE_ABILITY(RI_ABILITY_SWIM)) || (CAN_PLAY_SONG(SOARING) && CAN_OWL_WARP(OWL_WARP_GREAT_BAY_COAST))),
            CHECK(RC_GREAT_BAY_COAST_MIKAU, CAN_PLAY_SONG(HEALING)),
            CHECK(RC_GREAT_BAY_COAST_PIECE_OF_HEART, CAN_HOOK_SCARECROW && CAN_GROW_BEAN_PLANT && CAN_USE_ABILITY(RI_ABILITY_SWIM)),
            CHECK(RC_GREAT_BAY_COAST_POT_01, CAN_USE_ABILITY(RI_ABILITY_SWIM)),
            CHECK(RC_GREAT_BAY_COAST_POT_02, CAN_USE_ABILITY(RI_ABILITY_SWIM)),
            CHECK(RC_GREAT_BAY_COAST_POT_03, CAN_USE_ABILITY(RI_ABILITY_SWIM)),
            CHECK(RC_GREAT_BAY_COAST_POT_04, CAN_USE_ABILITY(RI_ABILITY_SWIM)),
            CHECK(RC_GREAT_BAY_COAST_POT_05, CAN_USE_ABILITY(RI_ABILITY_SWIM)),
            CHECK(RC_GREAT_BAY_COAST_POT_06, CAN_USE_ABILITY(RI_ABILITY_SWIM)),
            CHECK(RC_GREAT_BAY_COAST_POT_07, CAN_USE_ABILITY(RI_ABILITY_SWIM)),
            CHECK(RC_GREAT_BAY_COAST_POT_08, CAN_USE_ABILITY(RI_ABILITY_SWIM)),
            CHECK(RC_GREAT_BAY_COAST_POT_09, CAN_USE_ABILITY(RI_ABILITY_SWIM) || (CAN_PLAY_SONG(SOARING) && CAN_OWL_WARP(OWL_WARP_GREAT_BAY_COAST))),
            CHECK(RC_GREAT_BAY_COAST_POT_10, CAN_USE_ABILITY(RI_ABILITY_SWIM) || (CAN_PLAY_SONG(SOARING) && CAN_OWL_WARP(OWL_WARP_GREAT_BAY_COAST))),
            CHECK(RC_GREAT_BAY_COAST_POT_11, CAN_USE_ABILITY(RI_ABILITY_SWIM) || (CAN_PLAY_SONG(SOARING) && CAN_OWL_WARP(OWL_WARP_GREAT_BAY_COAST))),
            CHECK(RC_GREAT_BAY_COAST_POT_12, CAN_USE_ABILITY(RI_ABILITY_SWIM) || (CAN_PLAY_SONG(SOARING) && CAN_OWL_WARP(OWL_WARP_GREAT_BAY_COAST))),
            CHECK(RC_GREAT_BAY_COAST_LEDGE_POT_01, HAS_ITEM(ITEM_HOOKSHOT) && CAN_USE_ABILITY(RI_ABILITY_SWIM)),
            CHECK(RC_GREAT_BAY_COAST_LEDGE_POT_02, HAS_ITEM(ITEM_HOOKSHOT) && CAN_USE_ABILITY(RI_ABILITY_SWIM)),
            CHECK(RC_GREAT_BAY_COAST_LEDGE_POT_03, HAS_ITEM(ITEM_HOOKSHOT) && CAN_USE_ABILITY(RI_ABILITY_SWIM)),
            CHECK(RC_GREAT_BAY_COAST_TINGLE_MAP_01, (HAS_ITEM(ITEM_BOW) || HAS_ITEM(ITEM_HOOKSHOT)) && CAN_AFFORD(RC_GREAT_BAY_COAST_TINGLE_MAP_01) && (CAN_USE_ABILITY(RI_ABILITY_SWIM) || (CAN_PLAY_SONG(SOARING) && CAN_OWL_WARP(OWL_WARP_GREAT_BAY_COAST)))),
            CHECK(RC_GREAT_BAY_COAST_TINGLE_MAP_02, (HAS_ITEM(ITEM_BOW) || HAS_ITEM(ITEM_HOOKSHOT)) && CAN_AFFORD(RC_GREAT_BAY_COAST_TINGLE_MAP_02) && (CAN_USE_ABILITY(RI_ABILITY_SWIM) || (CAN_PLAY_SONG(SOARING) && CAN_OWL_WARP(OWL_WARP_GREAT_BAY_COAST)))),
        ...
        .exits = { //     TO                                         FROM
            ...
            EXIT(ENTRANCE(PINNACLE_ROCK, 0),                ENTRANCE(GREAT_BAY_COAST, 3), CAN_USE_ABILITY(RI_ABILITY_SWIM)),
            EXIT(ENTRANCE(FISHERMANS_HUT, 0),               ENTRANCE(GREAT_BAY_COAST, 4), true),
            EXIT(ENTRANCE(PIRATES_FORTRESS_EXTERIOR, 0),    ENTRANCE(GREAT_BAY_COAST, 5), CAN_BE_ZORA && CAN_USE_ABILITY(RI_ABILITY_SWIM)),
            EXIT(ENTRANCE(MARINE_RESEARCH_LAB, 0),          ENTRANCE(GREAT_BAY_COAST, 7), (CAN_USE_ABILITY(RI_ABILITY_SWIM) || (CAN_PLAY_SONG(SOARING) && CAN_OWL_WARP(OWL_WARP_GREAT_BAY_COAST)))),
            EXIT(ENTRANCE(OCEANSIDE_SPIDER_HOUSE, 0),       ENTRANCE(GREAT_BAY_COAST, 8), true),
        },
        .connections = {
            CONNECTION(RR_GREAT_BAY_COAST_COW_GROTTO, CAN_HOOK_SCARECROW && CAN_GROW_BEAN_PLANT && CAN_USE_ABILITY(RI_ABILITY_SWIM)), // TODO: Grotto mapping
    ...
    Regions[RR_PINNACLE_ROCK_INNER] = RandoRegion{ .name = "Inner", .sceneId = SCENE_SINKAI,
        ...
        .connections = {
            CONNECTION(RR_PINNACLE_ROCK_ENTRANCE, CAN_USE_ABILITY(RI_ABILITY_SWIM))
        },
        .events = {
    ...
    Regions[RR_WATERFALL_RAPIDS] = RandoRegion{ .sceneId = SCENE_35TAKI,
        .checks = {
            CHECK(RC_WATERFALL_RAPIDS_BEAVER_RACE_01, CAN_BE_ZORA && CAN_USE_ABILITY(RI_ABILITY_SWIM)),
            CHECK(RC_WATERFALL_RAPIDS_BEAVER_RACE_02, CAN_BE_ZORA && CAN_USE_ABILITY(RI_ABILITY_SWIM)),
        },
        .exits = { //     TO                                         FROM
    ...
    Regions[RR_ZORA_CAPE] = RandoRegion{ .sceneId = SCENE_31MISAKI,
        .checks = {
            ...
            CHECK(RC_ZORA_CAPE_UNDERWATER_CHEST,          CAN_BE_ZORA && CAN_USE_ABILITY(RI_ABILITY_SWIM)),
            CHECK(RC_ZORA_CAPE_WATERFALL_PIECE_OF_HEART,  CAN_BE_ZORA && CAN_USE_ABILITY(RI_ABILITY_SWIM)),
        ...
        .exits = { //     TO                                         FROM
            ...
            EXIT(ENTRANCE(ZORA_HALL, 0),                    ENTRANCE(ZORA_CAPE, 1), CAN_BE_ZORA && CAN_USE_ABILITY(RI_ABILITY_SWIM)),
