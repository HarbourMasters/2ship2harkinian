...
static RegisterShipInitFunc initFunc([]() {
    ...
    Regions[RR_GREAT_BAY_COAST] = RandoRegion{ .sceneId = SCENE_30GYOSON,
        .checks = {
            ...
            CHECK(RC_GREAT_BAY_COAST_OWL_STATUE, CAN_USE_SWORD && CAN_USE_ABILITY(RI_ABILITY_SWIM)),
            ...
            CHECK(RC_GREAT_BAY_COAST_POT_09, CAN_USE_ABILITY(RI_ABILITY_SWIM)),
            CHECK(RC_GREAT_BAY_COAST_POT_10, CAN_USE_ABILITY(RI_ABILITY_SWIM)),
            CHECK(RC_GREAT_BAY_COAST_POT_11, CAN_USE_ABILITY(RI_ABILITY_SWIM)),
            CHECK(RC_GREAT_BAY_COAST_POT_12, CAN_USE_ABILITY(RI_ABILITY_SWIM)),
            ...
            CHECK(RC_GREAT_BAY_COAST_TINGLE_MAP_01, (HAS_ITEM(ITEM_BOW) || HAS_ITEM(ITEM_HOOKSHOT)) && CAN_AFFORD(RC_GREAT_BAY_COAST_TINGLE_MAP_01) && CAN_USE_ABILITY(RI_ABILITY_SWIM)),
            CHECK(RC_GREAT_BAY_COAST_TINGLE_MAP_02, (HAS_ITEM(ITEM_BOW) || HAS_ITEM(ITEM_HOOKSHOT)) && CAN_AFFORD(RC_GREAT_BAY_COAST_TINGLE_MAP_02) && CAN_USE_ABILITY(RI_ABILITY_SWIM)),
