...
std::map<RandoItemId, RandoStaticItem> Items = {
    ...
    RI(RI_FROG_BLUE,                  "a",    "Frog",                       RITYPE_MAJOR,           ITEM_NONE,                       GI_NONE,                     GID_NONE),
    RI(RI_FROG_CYAN,                  "a",    "Frog",                       RITYPE_MAJOR,           ITEM_NONE,                       GI_NONE,                     GID_NONE),
    RI(RI_FROG_PINK,                  "a",    "Frog",                       RITYPE_MAJOR,           ITEM_NONE,                       GI_NONE,                     GID_NONE),
    RI(RI_FROG_WHITE,                 "a",    "Frog",                       RITYPE_MAJOR,           ITEM_NONE,                       GI_NONE,                     GID_NONE),
