...
std::unordered_map<StartingItemCategory, std::vector<RandoItemId>> StartingItemsMap = {
    { STARTING_ITEMS_INVENTORY,
      { RI_OCARINA, RI_PROGRESSIVE_BOW, RI_ARROW_FIRE, RI_ARROW_ICE, RI_ARROW_LIGHT, RI_PROGRESSIVE_BOMB_BAG,
        RI_BOMBCHU, RI_DEKU_STICK, RI_DEKU_NUT, RI_MAGIC_BEAN, RI_POWDER_KEG, RI_PICTOGRAPH_BOX, RI_LENS, RI_HOOKSHOT,
        RI_GREAT_FAIRY_SWORD, RI_BOTTLE_EMPTY } },
    { STARTING_ITEMS_MASK,
    ...
    { STARTING_ITEMS_QUEST,
      { RI_BOMBERS_NOTEBOOK,  RI_REMAINS_ODOLWA,      RI_REMAINS_GOHT,      RI_REMAINS_GYORG,  RI_REMAINS_TWINMOLD,
        RI_PROGRESSIVE_SWORD, RI_SHIELD_HERO,         RI_PROGRESSIVE_MAGIC, RI_DOUBLE_DEFENSE, RI_PROGRESSIVE_WALLET,
...
std::vector<RandoItemId> StartingItemsMaps = {
    RI_GREAT_SPIN_ATTACK,   RI_PROGRESSIVE_BOMB_BAG, RI_PROGRESSIVE_BOMB_BAG, RI_PROGRESSIVE_BOMB_BAG,
    RI_PROGRESSIVE_BOW,     RI_PROGRESSIVE_BOW,      RI_PROGRESSIVE_BOW,      RI_PROGRESSIVE_MAGIC,
    RI_PROGRESSIVE_MAGIC,   RI_PROGRESSIVE_SWORD,    RI_PROGRESSIVE_SWORD,    RI_PROGRESSIVE_SWORD,
    RI_PROGRESSIVE_WALLET,  RI_PROGRESSIVE_WALLET,   RI_SHIELD_HERO,          RI_SHIELD_MIRROR,
    RI_PROGRESSIVE_LULLABY, RI_PROGRESSIVE_LULLABY,
};
