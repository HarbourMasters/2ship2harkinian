...
std::map<RandoItemId, RandoStaticItem> Items = {
    ...
    RI(RI_BOMB_BAG_20,                "a",    "Bomb Bag",                    "un ",    "Sac de Bombes",                                  "eine",  "ein",    "Bombentasche",                             "TODO_JAPANESE_ARTICLE",  "TODO_JAPANESE_NAME",  "TODO_SPANISH_ARTICLE", "TODO_SPANISH_NAME",         RITYPE_MAJOR,           ITEM_BOMB_BAG_20,                GI_BOMB_BAG_20,              GID_BOMB_BAG_20),
    ...
    RI(RI_HEART_PIECE,                "a",    "Piece of Heart",              "un",     "Quart de Coeur",                                 "ein",   "ein",    "Herzteil",                                 "TODO_JAPANESE_ARTICLE",  "TODO_JAPANESE_NAME",  "TODO_SPANISH_ARTICLE", "TODO_SPANISH_NAME",                RITYPE_HEALTH,          ITEM_HEART_PIECE,                GI_HEART_PIECE,              GID_HEART_PIECE),
    ...
    RI(RI_MASK_COUPLE,                "the",  "Couple's Mask",               "le",     "Masque des Amoureux",                            "die",   "die",    "Maske der Liebenden",                      "TODO_JAPANESE_ARTICLE",  "TODO_JAPANESE_NAME",  "TODO_SPANISH_ARTICLE", "TODO_SPANISH_NAME",               RITYPE_MASK,            ITEM_MASK_COUPLE,                GI_MASK_COUPLE,              GID_MASK_COUPLE),
