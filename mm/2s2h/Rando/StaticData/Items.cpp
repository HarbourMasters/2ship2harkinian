...
std::unordered_map<StartingItemCategory, std::vector<RandoItemId>> StartingItemsMap = {
    { STARTING_ITEMS_INVENTORY, { RI_OCARINA,     RI_PROGRESSIVE_BOW, RI_BOW,
                                  RI_QUIVER_40,   RI_QUIVER_50,       RI_ARROW_FIRE,
                                  RI_ARROW_ICE,   RI_ARROW_LIGHT,     RI_PROGRESSIVE_BOMB_BAG,
                                  RI_BOMB_BAG_20, RI_BOMB_BAG_30,     RI_BOMB_BAG_40,
    ...
    { STARTING_ITEMS_QUEST,
      { RI_BOMBERS_NOTEBOOK,   RI_REMAINS_ODOLWA,    RI_REMAINS_GOHT, RI_REMAINS_GYORG, RI_REMAINS_TWINMOLD,
        RI_PROGRESSIVE_SWORD,  RI_SWORD_KOKIRI,      RI_SWORD_RAZOR,  RI_SWORD_GILDED,  RI_SHIELD_HERO,
        RI_SHIELD_MIRROR,      RI_PROGRESSIVE_MAGIC, RI_SINGLE_MAGIC, RI_DOUBLE_MAGIC,  RI_DOUBLE_DEFENSE,
        RI_PROGRESSIVE_WALLET, RI_WALLET_ADULT,      RI_WALLET_GIANT, RI_SONG_TIME,     RI_SONG_HEALING,
        RI_SONG_EPONA,         RI_SONG_SOARING,      RI_SONG_STORMS,  RI_SONG_SONATA,   RI_PROGRESSIVE_LULLABY,
        RI_SONG_LULLABY_INTRO, RI_SONG_LULLABY,      RI_SONG_NOVA,    RI_SONG_ELEGY,    RI_SONG_OATH } },
    { STARTING_ITEMS_MASK,
      { RI_MASK_POSTMAN, RI_MASK_ALL_NIGHT, RI_MASK_BLAST,  RI_MASK_STONE,         RI_MASK_GREAT_FAIRY,
        RI_MASK_DEKU,    RI_MASK_KEATON,    RI_MASK_BREMEN, RI_MASK_BUNNY,         RI_MASK_DON_GERO,
        RI_MASK_SCENTS,  RI_MASK_GORON,     RI_MASK_ROMANI, RI_MASK_CIRCUS_LEADER, RI_MASK_KAFEIS_MASK,
        RI_MASK_COUPLE,  RI_MASK_TRUTH,     RI_MASK_ZORA,   RI_MASK_KAMARO,        RI_MASK_GIBDO,
        RI_MASK_GARO,    RI_MASK_CAPTAIN,   RI_MASK_GIANT,  RI_MASK_FIERCE_DEITY } },
...
std::vector<RandoItemId> StartingItemsExclusions = {
    RI_BOW,          RI_QUIVER_40,     RI_QUIVER_50,    RI_BOMB_BAG_20,        RI_BOMB_BAG_30,  RI_BOMB_BAG_40,
    RI_WALLET_ADULT, RI_WALLET_GIANT,  RI_SINGLE_MAGIC, RI_DOUBLE_MAGIC,       RI_SWORD_KOKIRI, RI_SWORD_RAZOR,
    RI_SWORD_GILDED, RI_SHIELD_MIRROR, RI_SONG_LULLABY, RI_SONG_LULLABY_INTRO,
};

std::unordered_map<RandoItemId, std::vector<RandoItemId>> ProgressiveItemsMap = {
    { RI_PROGRESSIVE_BOMB_BAG, { RI_BOMB_BAG_40, RI_BOMB_BAG_30, RI_BOMB_BAG_20 } },
    { RI_PROGRESSIVE_BOW, { RI_QUIVER_50, RI_QUIVER_40, RI_BOW } },
    { RI_PROGRESSIVE_MAGIC, { RI_DOUBLE_MAGIC, RI_SINGLE_MAGIC } },
    { RI_PROGRESSIVE_SWORD, { RI_SWORD_GILDED, RI_SWORD_RAZOR, RI_SWORD_KOKIRI } },
    { RI_PROGRESSIVE_WALLET, { RI_WALLET_GIANT, RI_WALLET_ADULT } },
    { RI_SHIELD_HERO, { RI_SHIELD_MIRROR, RI_SHIELD_HERO } }
};
