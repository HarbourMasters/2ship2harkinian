...
std::map<RandoItemId, RandoStaticItem> Items = {
    ...
    RI(RI_FROG_BLUE,                  "a",    "Blue Frog",                   "une",    "Grenouille Bleue",                               "eine",  "eine",   "TODO_GERMAN_NAME",                         "TODO_JAPANESE_ARTICLE",  "TODO_JAPANESE_NAME",  "TODO_SPANISH_ARTICLE", "TODO_SPANISH_NAME",             RITYPE_MAJOR,           ITEM_NONE,                       GI_MASK_DON_GERO,            GID_NONE),
    RI(RI_FROG_CYAN,                  "a",    "Cyan Frog",                   "une",    "Grenouille Bleu Ciel",                           "eine",  "eine",   "TODO_GERMAN_NAME",                         "TODO_JAPANESE_ARTICLE",  "TODO_JAPANESE_NAME",  "TODO_SPANISH_ARTICLE", "TODO_SPANISH_NAME",            RITYPE_MAJOR,           ITEM_NONE,                       GI_MASK_DON_GERO,            GID_NONE),
    RI(RI_FROG_PINK,                  "a",    "Pink Frog",                   "une",    "Grenouille Orange",                              "eine",  "eine",   "TODO_GERMAN_NAME",                         "TODO_JAPANESE_ARTICLE",  "TODO_JAPANESE_NAME",  "TODO_SPANISH_ARTICLE", "TODO_SPANISH_NAME",           RITYPE_MAJOR,           ITEM_NONE,                       GI_MASK_DON_GERO,            GID_NONE),
    RI(RI_FROG_WHITE,                 "a",    "White Frog"                   "une",    "Grenouille Blanche",                             "eine",  "eine",   "TODO_GERMAN_NAME",                         "TODO_JAPANESE_ARTICLE",  "TODO_JAPANESE_NAME",  "TODO_SPANISH_ARTICLE", "TODO_SPANISH_NAME",           RITYPE_MAJOR,           ITEM_NONE,                       GI_MASK_DON_GERO,            GID_NONE),
