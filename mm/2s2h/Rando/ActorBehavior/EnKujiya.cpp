...
void Rando::ActorBehavior::InitEnKujiyaBehavior() {
    ...
    COND_ID_HOOK(OnOpenText, 0x2b5c, IS_RANDO, [](u16* textId, bool* loadFromMessageTable) {
        ...
        entry.msg = LOCALIZED(
            "Step right up! For a measly %p10 Rupees%w, your dreams could come true!\x11\x13\x12"
            ...
            "Wähle drei Nummern. Wenn sie gezogen werden, gewinnst du {{article}}%p{{itemName}}%w. Nur %reiner%w kann "
            "gewinnen!\x19",
