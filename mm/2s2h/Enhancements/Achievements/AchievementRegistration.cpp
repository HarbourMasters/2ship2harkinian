...
void AchievementSystem::RegisterAchievements() {
    ...
    REGISTER_ACHIEVEMENT(
        ...
        false, 10, AchievementCategory::BOTH, OnSceneInit,
    ...
    REGISTER_ACHIEVEMENT("collect_goron_mask", "Stone Face", "Obtain the Goron Mask",
                         (const char*)gItemIcons[ITEM_MASK_GORON], false, 10, AchievementCategory::BOTH, OnActorInit,
    ...
    REGISTER_ACHIEVEMENT("collect_postman_hat", "Delivery for a Link?", "Obtain the Postman's Hat",
                         (const char*)gItemIcons[ITEM_MASK_POSTMAN], false, 10, AchievementCategory::BOTH, OnActorInit,
    ...
    REGISTER_ACHIEVEMENT("collect_blast_mask", "Face bomber", "Obtain the Blast Mask",
                         (const char*)gItemIcons[ITEM_MASK_BLAST], false, 10, AchievementCategory::BOTH, OnActorInit,
                         INV_CONTENT(ITEM_MASK_BLAST) == ITEM_MASK_BLAST);

    REGISTER_ACHIEVEMENT("collect_stone_mask", "I got a rock...", "Obtain the Stone Mask",
                         (const char*)gItemIcons[ITEM_MASK_STONE], false, 10, AchievementCategory::BOTH, OnActorInit,
    ...
    REGISTER_ACHIEVEMENT("collect_keaton_mask", "Two-Tailed deceiver", "Obtain the Keaton Mask",
                         (const char*)gItemIcons[ITEM_MASK_KEATON], false, 10, AchievementCategory::BOTH, OnActorInit,
    ...
    REGISTER_ACHIEVEMENT("collect_bremen_mask", "Leader of Animals", "Obtain the Bremen Mask",
                         (const char*)gItemIcons[ITEM_MASK_BREMEN], false, 10, AchievementCategory::BOTH, OnActorInit,
    ...
    REGISTER_ACHIEVEMENT("collect_bunny_hood", "Speedy as a Hare", "Obtain the Bunny Hood",
                         (const char*)gItemIcons[ITEM_MASK_BUNNY], false, 10, AchievementCategory::BOTH, OnActorInit,
                         INV_CONTENT(ITEM_MASK_BUNNY) == ITEM_MASK_BUNNY);

    REGISTER_ACHIEVEMENT("collect_dongero_mask", "*Kero Kero*", "Obtain the Dongero Mask",
                         (const char*)gItemIcons[ITEM_MASK_DON_GERO], false, 10, AchievementCategory::BOTH, OnActorInit,
    ...
    REGISTER_ACHIEVEMENT("collect_mask_of_scents", "Sniffer of many things", "Obtain the Mask of Scents",
                         (const char*)gItemIcons[ITEM_MASK_SCENTS], false, 10, AchievementCategory::BOTH, OnActorInit,
    ...
    REGISTER_ACHIEVEMENT("collect_romani_mask", "Mark of maturity", "Obtain the Romani Mask",
                         (const char*)gItemIcons[ITEM_MASK_ROMANI], false, 10, AchievementCategory::BOTH, OnActorInit,
    ...
    REGISTER_ACHIEVEMENT("collect_couples_mask", "Witness of union", "Obtain the Couple's Mask",
                         (const char*)gItemIcons[ITEM_MASK_COUPLE], false, 10, AchievementCategory::BOTH, OnActorInit,
    ...
    REGISTER_ACHIEVEMENT("collect_mask_of_truth", "Seer of Truth", "Obtain the Mask of Truth",
                         (const char*)gItemIcons[ITEM_MASK_TRUTH], false, 10, AchievementCategory::BOTH, OnActorInit,
    ...
    REGISTER_ACHIEVEMENT("collect_kamaro_mask", "Lord of the Dance", "Obtain the Kamaro Mask",
                         (const char*)gItemIcons[ITEM_MASK_KAMARO], false, 10, AchievementCategory::BOTH, OnActorInit,
    ...
    REGISTER_ACHIEVEMENT("collect_gibdo_mask", "Mummified Taskmaster", "Obtain the Gibdo Mask",
                         (const char*)gItemIcons[ITEM_MASK_GIBDO], false, 10, AchievementCategory::BOTH, OnActorInit,
    ...
    REGISTER_ACHIEVEMENT("collect_captains_hat", "I'm the Captain now!", "Obtain the Captain's Hat",
                         (const char*)gItemIcons[ITEM_MASK_CAPTAIN], false, 10, AchievementCategory::BOTH, OnActorInit,
                         INV_CONTENT(ITEM_MASK_CAPTAIN) == ITEM_MASK_CAPTAIN);

    REGISTER_ACHIEVEMENT("collect_giants_hat", "5th Giant", "Obtain the Giant's Mask",
                         (const char*)gItemIcons[ITEM_MASK_GIANT], false, 10, AchievementCategory::BOTH, OnActorInit,
    ...
    REGISTER_ACHIEVEMENT("defeat_aliens", "Flatwoods Buster", "Defend Ranch from Alien threat",
                         (const char*)gItemIcons[ITEM_MILK_BOTTLE], false, 10, AchievementCategory::BOTH, OnActorInit,
                         CHECK_WEEKEVENTREG(WEEKEVENTREG_DEFENDED_AGAINST_THEM));

    REGISTER_ACHIEVEMENT("hags_hero", "Hag's Hero", "Save Koume", (const char*)gItemIcons[ITEM_POTION_RED], false, 10,
                         AchievementCategory::BOTH, OnActorInit, CHECK_WEEKEVENTREG(WEEKEVENTREG_SAVED_KOUME));

    REGISTER_ACHIEVEMENT("speed_demon", "Speed Demon", "Win the Goron race", (const char*)gItemIcons[ITEM_GOLD_DUST],
                         false, 10, AchievementCategory::BOTH, OnActorInit, CHECK_WEEKEVENTREG(WEEKEVENTREG_41_08));
    ...
    REGISTER_ACHIEVEMENT("collect_magic", "Novice Magician", "Obtained Magic",
                         (const char*)gItemIcons[ITEM_MAGIC_JAR_SMALL], true, 5, AchievementCategory::BOTH, OnActorInit,
                         gSaveContext.save.saveInfo.playerData.isMagicAcquired == true);

    REGISTER_ACHIEVEMENT("collect_great_spin", "Master Spinner", "Obtain the Great Spin",
                         (const char*)gItemIcons[ITEM_SWORD_KOKIRI], true, 20, AchievementCategory::BOTH, OnActorInit,
    ...
    REGISTER_ACHIEVEMENT("learn_song_of_time", "Time Traveler", "Learn the Song of Time",
                         ...
                         OnActorInit, CHECK_QUEST_ITEM(QUEST_SONG_TIME));

    REGISTER_ACHIEVEMENT("learn_song_of_healing", "Soul Healer", "Learn the Song of Healing",
                         (const char*)gItemIcons[ITEM_OCARINA_OF_TIME], false, 10, AchievementCategory::BOTH,
                         OnActorInit, CHECK_QUEST_ITEM(QUEST_SONG_HEALING));
