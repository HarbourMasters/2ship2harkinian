    ...
    []() {
        ...
        REGISTER_ACHIEVEMENT("first_steps", "Beyond the Town Walls",
                             ...
                             OnFlagSet, [](FlagType flagType, u32 flag) {
                                 return flagType == FLAG_WEEK_EVENT_REG && flag == WEEKEVENTREG_ENTERED_TERMINA_FIELD;
                             });
        ...
        REGISTER_ACHIEVEMENT("defeat_gyorg", "Ocean Conqueror", "Defeat Gyorg, Gargantuan Masked Fish",
                             ...
                             OnFlagSet, [](FlagType flagType, u32 flag) {
                                 return flagType == FLAG_WEEK_EVENT_REG &&
                                        flag == WEEKEVENTREG_CLEARED_GREAT_BAY_TEMPLE;
                             });
        ...
        REGISTER_ACHIEVEMENT("defeat_twinmold", "Desert Exterminator", "Defeat Twinmold, Giant Masked Insects",
                             ...
                             OnFlagSet, [](FlagType flagType, u32 flag) {
                                 return flagType == FLAG_WEEK_EVENT_REG &&
                                        flag == WEEKEVENTREG_CLEARED_STONE_TOWER_TEMPLE;
                             });

        REGISTER_ACHIEVEMENT(
            "defeat_majora", "Savior of Termina", "Defeat Majora and save Termina",
            (const char*)gItemIcons[ITEM_MASK_FIERCE_DEITY], false, 50, AchievementCategory::BOTH, OnFlagSet,
            [](FlagType flagType, u32 flag) { return flagType == FLAG_WEEK_EVENT_REG && flag == WEEKEVENTREG_77_01; });
        ...
        REGISTER_ACHIEVEMENT("collect_postman_hat", "Delivery for a Link?", "Obtain the Postman's Hat",
                             ...
                             OnItemGive, [](u8 item) { return item == ITEM_MASK_POSTMAN; });
        ...
        REGISTER_ACHIEVEMENT("collect_allnight_mask", "Up for 24h/3d", "Obtain the All-Night Mask",
                             ...
                             OnItemGive, [](u8 item) { return item == ITEM_MASK_ALL_NIGHT; });
        ...
        REGISTER_ACHIEVEMENT("collect_keaton_mask", "Two-Tailed deceiver", "Obtain the Keaton Mask",
                             ...
                             OnItemGive, [](u8 item) { return item == ITEM_MASK_KEATON; });
        ...
        REGISTER_ACHIEVEMENT("collect_bremen_mask", "Leader of Animals", "Obtain the Bremen Mask",
                             ...
                             OnItemGive, [](u8 item) { return item == ITEM_MASK_BREMEN; });
        ...
        REGISTER_ACHIEVEMENT("collect_dongero_mask", "*Kero Kero*", "Obtain the Dongero Mask",
                             ...
                             OnItemGive, [](u8 item) { return item == ITEM_MASK_DON_GERO; });
        ...
        REGISTER_ACHIEVEMENT("collect_mask_of_scents", "Sniffer of many things", "Obtain the Mask of Scents",
                             ...
                             OnItemGive, [](u8 item) { return item == ITEM_MASK_SCENTS; });
        ...
        REGISTER_ACHIEVEMENT("collect_romani_mask", "Mark of maturity", "Obtain the Romani Mask",
                             ...
                             OnItemGive, [](u8 item) { return item == ITEM_MASK_ROMANI; });
        ...
        REGISTER_ACHIEVEMENT("collect_couples_mask", "Witness of union", "Obtain the Couple's Mask",
                             ...
                             OnItemGive, [](u8 item) { return item == ITEM_MASK_COUPLE; });
        ...
        REGISTER_ACHIEVEMENT("collect_kamaro_mask", "Lord of the Dance", "Obtain the Kamaro Mask",
                             ...
                             OnItemGive, [](u8 item) { return item == ITEM_MASK_KAMARO; });
        ...
        REGISTER_ACHIEVEMENT("collect_captains_hat", "I'm the Captain now!", "Obtain the Captain's Hat",
                             ...
                             OnItemGive, [](u8 item) { return item == ITEM_MASK_CAPTAIN; });
        ...
        // Event achievements
        REGISTER_ACHIEVEMENT(
            "eavesdropper", "Eavesdropper", "Listen in on Anju and her Mothers conversation",
        ...
        REGISTER_ACHIEVEMENT(
            "speed_demon", "Speed Demon", "Win the Goron race", (const char*)gItemIcons[ITEM_GOLD_DUST], false, 10,
            AchievementCategory::BOTH, OnFlagSet,
            [](FlagType flagType, u32 flag) { return flagType == FLAG_WEEK_EVENT_REG && flag == WEEKEVENTREG_41_08; });
        ...
        REGISTER_ACHIEVEMENT(
            "laborious_swimmer", "Laborious Swimmer", "Win the final Beaver race reward",
            (const char*)gItemIcons[ITEM_MASK_ZORA], false, 10, AchievementCategory::BOTH, OnFlagSet,
        ...
        REGISTER_ACHIEVEMENT(
            "honey_and_darling_showstopper", "Honey and Darling Showstopper", "Win the Honey & Darling Heart Piece",
            (const char*)gItemIcons[ITEM_BOW], false, 10, AchievementCategory::BOTH, OnFlagSet,
        ...
        REGISTER_ACHIEVEMENT("deku_champion", "Playground Champ", "Win final Deku Playground reward",
                             ...
                             [](FlagType flagType, u32 flag) {
                                 return flagType == FLAG_WEEK_EVENT_REG &&
                                        flag == WEEKEVENTREG_RECEIVED_DEKU_PLAYGROUND_HEART_PIECE;
                             });

        REGISTER_ACHIEVEMENT(
            "swamp_photographer", "Swamp Photographer", "Complete the Swamp Boat Tour and receive the Pictograph Box",
            ...
            OnFlagSet,
            [](FlagType flagType, u32 flag) { return flagType == FLAG_WEEK_EVENT_REG && flag == WEEKEVENTREG_61_10; });
        ...
        REGISTER_ACHIEVEMENT("island_hopper", "Island Hopper", "Win the Greatbay Island minigame reward",
                             ...
                             OnFlagSet, [](FlagType flagType, u32 flag) {
                                 return flagType == FLAG_WEEK_EVENT_REG && flag == WEEKEVENTREG_82_10;
                             });
        ...
        REGISTER_ACHIEVEMENT(
            "poebuster", "Poebuster", "Win the Spirit House reward", (const char*)gItemIcons[ITEM_BIG_POE], false, 10,
            AchievementCategory::BOTH, OnFlagSet,
            [](FlagType flagType, u32 flag) { return flagType == FLAG_WEEK_EVENT_REG && flag == WEEKEVENTREG_54_40; });

        REGISTER_ACHIEVEMENT(
            "seacrossed_reunion", "Seacrossed Reunion", "Reunite the Seahorses", (const char*)gItemIcons[ITEM_SEAHORSE],
            false, 10, AchievementCategory::BOTH, OnFlagSet,
            [](FlagType flagType, u32 flag) { return flagType == FLAG_WEEK_EVENT_REG && flag == WEEKEVENTREG_32_01; });

        REGISTER_ACHIEVEMENT(
            "max_health", "Full of Heart", "Obtain maximum health (20 hearts)",
            (const char*)gItemIcons[ITEM_HEART_CONTAINER], true, 30, AchievementCategory::BOTH, OnActorInit,
            [](Actor* actor) { return gSaveContext.save.saveInfo.playerData.healthCapacity >= 0x140; });

        // Fairy achievements
        REGISTER_ACHIEVEMENT("lost_and_found", "Lost and Found", "Collect the lost Stray Fairy in Clock Town",
                             ...
                             OnFlagSet, [](FlagType flagType, u32 flag) {
                                 return flagType == FLAG_WEEK_EVENT_REG && flag == WEEKEVENTREG_08_80;
                             });

        REGISTER_ACHIEVEMENT(
            "collect_great_spin", "Master Spinner", "Obtain the Great Spin", (const char*)gItemIcons[ITEM_SWORD_KOKIRI],
        ...
        REGISTER_ACHIEVEMENT(
            "master_healer", "Master Healer", "Heal all cursed souls with the Song of Healing",
