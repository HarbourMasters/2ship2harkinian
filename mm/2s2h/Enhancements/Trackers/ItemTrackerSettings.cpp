...
void ItemTrackerSettingsWindow::DrawElement() {
    ...
    UIWidgets::Combobox("Frogs", mItemTrackerWindow->GetDrawModePtr(SECTION_FROGS), displayTypes);
    UIWidgets::Combobox("Gold Skulltulas", mItemTrackerWindow->GetDrawModePtr(SECTION_GOLD_SKULLTULAS), displayTypes);
    UIWidgets::Combobox("Clocks", mItemTrackerWindow->GetDrawModePtr(SECTION_CLOCKS), displayTypes);
