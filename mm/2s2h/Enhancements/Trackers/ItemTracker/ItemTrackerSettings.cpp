...
void ItemTrackerSettingsWindow::DrawElement() {
    ...
    // UIWidgets::Combobox("Gold Skulltulas", mItemTrackerWindow->GetDrawModePtr(SECTION_GOLD_SKULLTULAS),
    // displayTypes); UIWidgets::Combobox("Dungeon Items", mItemTrackerWindow->GetDrawModePtr(SECTION_DUNGEON),
    // displayTypes);
    //
    // UIWidgets::Checkbox(
