...
void Init() {
    ...
    flagToEventMap = {
        ...
        TRACK_FLAG(FLAG_WEEK_EVENT_REG, WEEKEVENTREG_BOMBERS_NOTEBOOK_EVENT_DEPOSITED_LETTER_TO_KAFEI,
        ...
        TRACK_FLAG(FLAG_WEEK_EVENT_REG, WEEKEVENTREG_BOMBERS_NOTEBOOK_EVENT_PROMISED_TO_HELP_WITH_ALIENS, 
                   EVENT_PROMISED_TO_HELP_WITH_THEM),
        TRACK_FLAG(FLAG_WEEK_EVENT_REG, WEEKEVENTREG_BOMBERS_NOTEBOOK_EVENT_DEFENDED_AGAINST_ALIENS, 
                   EVENT_DEFENDED_AGAINST_THEM),
        TRACK_FLAG(FLAG_WEEK_EVENT_REG, WEEKEVENTREG_BOMBERS_NOTEBOOK_EVENT_RECEIVED_ALIENS_BOTTLE, 
        ...
        // Additional events (Currently unused)
        TRACK_FLAG(FLAG_WEEK_EVENT_REG, WEEKEVENTREG_TINGLE_MAP_BOUGHT_CLOCK_TOWN,
                   EVENT_TINGLE_MAP_CLOCK_TOWN),
        TRACK_FLAG(FLAG_WEEK_EVENT_REG, WEEKEVENTREG_TINGLE_MAP_BOUGHT_WOODFALL,
                   EVENT_TINGLE_MAP_WOODFALL),
        TRACK_FLAG(FLAG_WEEK_EVENT_REG, WEEKEVENTREG_TINGLE_MAP_BOUGHT_SNOWHEAD,
                   EVENT_TINGLE_MAP_SNOWHEAD),
        TRACK_FLAG(FLAG_WEEK_EVENT_REG, WEEKEVENTREG_TINGLE_MAP_BOUGHT_ROMANI_RANCH,
                   EVENT_TINGLE_MAP_ROMANI_RANCH),
        TRACK_FLAG(FLAG_WEEK_EVENT_REG, WEEKEVENTREG_RECEIVED_LAND_TITLE_DEED,
                   EVENT_RECEIVED_LAND_TITLE_DEED),
        TRACK_FLAG(FLAG_WEEK_EVENT_REG, WEEKEVENTREG_60_01,
                   EVENT_BANK_REWARD_3),
        TRACK_FLAG(FLAG_WEEK_EVENT_REG, WEEKEVENTREG_59_80,
                   EVENT_BANK_REWARD_2),
        TRACK_FLAG(FLAG_WEEK_EVENT_REG, WEEKEVENTREG_RECEIVED_BANK_WALLET_UPGRADE,
                   EVENT_BANK_REWARD_1),
        TRACK_FLAG(FLAG_WEEK_EVENT_REG, WEEKEVENTREG_93_02,
                   EVENT_RECEIVED_MASK_OF_SCENTS),
        TRACK_FLAG(FLAG_WEEK_EVENT_REG, WEEKEVENTREG_RECEIVED_DOGGY_RACETRACK_HEART_PIECE,
                   EVENT_RECEIVED_DOGGY_RACETRACK_HP),
        TRACK_FLAG(FLAG_WEEK_EVENT_REG, WEEKEVENTREG_RECEIVED_GREAT_SPIN_ATTACK,
                   EVENT_RECEIVED_GREAT_SPIN_ATTACK),
        TRACK_FLAG(FLAG_WEEK_EVENT_REG, WEEKEVENTREG_RECEIVED_GORON_RACE_BOTTLE,
                   EVENT_GORON_RACE_REWARD),
        TRACK_FLAG(FLAG_WEEK_EVENT_REG, WEEKEVENTREG_62_01,
                   EVENT_RECEIVED_BOMB_BAG_FROM_GORON_SCRUB),
        TRACK_FLAG(FLAG_WEEK_EVENT_REG, WEEKEVENTREG_61_80,
                   EVENT_RECEIVED_MOUNTAIN_TITLE_DEED),
        TRACK_FLAG(FLAG_WEEK_EVENT_REG, WEEKEVENTREG_RECEIVED_HONEY_AND_DARLING_HEART_PIECE,
                   EVENT_HONEY_DARLING_REWARD_ALL_DAYS),
        TRACK_FLAG(FLAG_WEEK_EVENT_REG, WEEKEVENTREG_22_10,
                   EVENT_HONEY_DARLING_REWARD_ANY_DAY),
        TRACK_FLAG(FLAG_WEEK_EVENT_REG, WEEKEVENTREG_RECEIVED_MARINE_RESEARCH_LAB_FISH_HEART_PIECE,
                   EVENT_RECEIVED_LAB_FISH_HP),
        TRACK_FLAG(FLAG_WEEK_EVENT_REG, WEEKEVENTREG_20_40,
                   EVENT_LEARNED_ZORA_SONG),
        TRACK_FLAG(FLAG_WEEK_EVENT_REG, WEEKEVENTREG_61_01,
                   EVENT_RECEIVED_DON_GERO_MASK),
        TRACK_FLAG(FLAG_WEEK_EVENT_REG, WEEKEVENTREG_74_40,
                   EVENT_RECEIVED_MOON_TEAR),
        TRACK_FLAG(FLAG_WEEK_EVENT_REG, WEEKEVENTREG_RECEIVED_SEAHORSE_HEART_PIECE,
                   EVENT_RECEIVED_PINNACLE_ROCK_HP),
        TRACK_FLAG(FLAG_WEEK_EVENT_REG, WEEKEVENTREG_RECEIVED_TOWN_SHOOTING_GALLERY_QUIVER_UPGRADE,
                   EVENT_TOWN_ARCHERY_REWARD_1),
        TRACK_FLAG(FLAG_WEEK_EVENT_REG, WEEKEVENTREG_RECEIVED_SWAMP_SHOOTING_GALLERY_QUIVER_UPGRADE,
                   EVENT_SWAMP_ARCHERY_REWARD_1),
        TRACK_FLAG(FLAG_WEEK_EVENT_REG, WEEKEVENTREG_RECEIVED_SWAMP_SHOOTING_GALLERY_HEART_PIECE,
                   EVENT_SWAMP_ARCHERY_REWARD_2),
        TRACK_FLAG(FLAG_WEEK_EVENT_REG, WEEKEVENTREG_61_10,
                   EVENT_RECEIVED_SWAMP_TITLE_DEED),
        TRACK_FLAG(FLAG_WEEK_EVENT_REG, WEEKEVENTREG_RECEIVED_SWORDSMANS_SCHOOL_HEART_PIECE,
                   EVENT_SWORDSMAN_SCHOOL_HP),
        TRACK_FLAG(FLAG_WEEK_EVENT_REG, WEEKEVENTREG_26_40,
                   EVENT_BOAT_ARCHERY_HEART_PIECE),
        TRACK_FLAG(FLAG_WEEK_EVENT_REG, WEEKEVENTREG_24_10,
                   EVENT_LEARNED_GORON_LULLABY_INTRO),
        TRACK_FLAG(FLAG_WEEK_EVENT_REG, WEEKEVENTREG_RECEIVED_BEAVER_BROS_HEART_PIECE,
                   EVENT_BEAVER_RACE_2),
        TRACK_FLAG(FLAG_WEEK_EVENT_REG, WEEKEVENTREG_RECEIVED_BEAVER_RACE_BOTTLE,
                   EVENT_BEAVER_RACE_1),
        TRACK_FLAG(FLAG_WEEK_EVENT_REG, WEEKEVENTREG_84_10,
                   EVENT_RECEIVED_RED_POTION),
        TRACK_FLAG(FLAG_WEEK_EVENT_REG, WEEKEVENTREG_62_04,
                   EVENT_RECEIVED_OCEAN_TITLE_DEED),
        TRACK_FLAG(FLAG_WEEK_EVENT_REG, WEEKEVENTREG_RECEIVED_EVAN_HEART_PIECE,
    ...
    sceneFlagToEventMap = {
        ...
        TRACK_SCENE_FLAG(SCENE_DEKU_KING, FLAG_CYCL_SCENE_SWITCH, 0x0B,
                        EVENT_LEARNED_SONATA_OF_AWAKENING),
        TRACK_SCENE_FLAG(SCENE_11GORONNOSATO, FLAG_CYCL_SCENE_COLLECTIBLE, 0x34,
                        EVENT_RECEIVED_POWDER_KEG),
        TRACK_SCENE_FLAG(SCENE_ALLEY, FLAG_CYCL_SCENE_COLLECTIBLE, 0x7F,
                        EVENT_CLOCK_TOWN_STRAY_FAIRY),
        TRACK_SCENE_FLAG(SCENE_MAP_SHOP, FLAG_PERM_SCENE_COLLECTIBLE, 0x43,
                        EVENT_RECEIVED_PICTOGRAPH_BOX),
        TRACK_SCENE_FLAG(SCENE_MAP_SHOP, FLAG_CYCL_SCENE_COLLECTIBLE, 0x0C,
                        EVENT_TINGLE_PICTURE_HEART_PIECE),
        TRACK_SCENE_FLAG(SCENE_20SICHITAI2, FLAG_CYCL_SCENE_SWITCH, 0x0B,
