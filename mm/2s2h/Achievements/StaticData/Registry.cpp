...
void Init() {
    ...
    Data = {
        ...
        ACHIEVEMENT_ENTRY(AI(BN_ALWAYS_MAKES_HIS_APPOINTED_DELIVERIES),
            ...
            AE(EVENT_DEPOSITED_LETTER_TO_KAFEI),
    ...
    EventData = {
        ...
        EVENT_ENTRY(AE(EVENT_DEPOSITED_LETTER_TO_KAFEI), "Deposited Letter to Kafei",
        ...
        EVENT_ENTRY(AE(EVENT_TINGLE_MAP_CLOCK_TOWN), "Bought Clock Town Map",
                    "Player bought the Clock Town map from Tingle"),
        EVENT_ENTRY(AE(EVENT_TINGLE_MAP_WOODFALL), "Bought Woodfall Map", "Player bought the Woodfall map from Tingle"),
        EVENT_ENTRY(AE(EVENT_TINGLE_MAP_SNOWHEAD), "Bought Snowhead Map", "Player bought the Snowhead map from Tingle"),
        EVENT_ENTRY(AE(EVENT_TINGLE_MAP_ROMANI_RANCH), "Bought Romani Ranch Map",
                    "Player bought the Romani Ranch map from Tingle"),
        EVENT_ENTRY(AE(EVENT_RECEIVED_LAND_TITLE_DEED), "Received Land Title Deed",
                    "Player obtained the Land Title Deed"),
        EVENT_ENTRY(AE(EVENT_BANK_REWARD_3), "Bank Reward 5000 Rupees", "Player earned the final bank reward"),
        EVENT_ENTRY(AE(EVENT_BANK_REWARD_2), "Bank Reward 200 Rupees", "Player earned the second bank reward"),
        EVENT_ENTRY(AE(EVENT_BANK_REWARD_1), "Bank Reward 200 Rupees", "Player earned the first bank reward"),
        EVENT_ENTRY(AE(EVENT_LEARNED_SONATA_OF_AWAKENING), "Learned Sonata of Awakening",
                    "Player learned the Sonata of Awakening"),
        EVENT_ENTRY(AE(EVENT_DEKU_PLAYGROUND_REWARD_ALL_DAYS), "Deku Playground Champion",
                    "Player cleared all three days at the Deku Playground"),
        EVENT_ENTRY(AE(EVENT_DEKU_PLAYGROUND_REWARD_ANY_DAY), "Deku Playground Clear",
                    "Player cleared a day at the Deku Playground"),
        EVENT_ENTRY(AE(EVENT_RECEIVED_MASK_OF_SCENTS), "Received Mask of Scents", "Player received the Mask of Scents"),
        EVENT_ENTRY(AE(EVENT_RECEIVED_DOGGY_RACETRACK_HP), "Doggy Racetrack Prize",
                    "Player won the Doggy Racetrack Heart Piece"),
        EVENT_ENTRY(AE(EVENT_RECEIVED_GREAT_SPIN_ATTACK), "Great Spin Attack", "Player obtained the Great Spin Attack"),
        EVENT_ENTRY(AE(EVENT_GORON_RACE_REWARD), "Goron Race Reward", "Player won the Goron Race"),
        EVENT_ENTRY(AE(EVENT_RECEIVED_BOMB_BAG_FROM_GORON_SCRUB), "Bought Bomb Bag",
                    "Player bought the Bomb Bag from the Goron Scrub"),
        EVENT_ENTRY(AE(EVENT_RECEIVED_MOUNTAIN_TITLE_DEED), "Received Mountain Title Deed",
                    "Player obtained the Mountain Title Deed"),
        EVENT_ENTRY(AE(EVENT_RECEIVED_POWDER_KEG), "Received Powder Keg", "Player received the Powder Keg"),
        EVENT_ENTRY(AE(EVENT_HONEY_DARLING_REWARD_ALL_DAYS), "Honey & Darling Champion",
                    "Player cleared all three Honey & Darling games"),
        EVENT_ENTRY(AE(EVENT_HONEY_DARLING_REWARD_ANY_DAY), "Honey & Darling Clear",
                    "Player cleared a Honey & Darling game"),
        EVENT_ENTRY(AE(EVENT_RECEIVED_LAB_FISH_HP), "Lab Fish Reward", "Player fed the lab fish and got a Heart Piece"),
        EVENT_ENTRY(AE(EVENT_LEARNED_ZORA_SONG), "Learned Zora Song", "Player learned the Zora Hall rehearsal song"),
        EVENT_ENTRY(AE(EVENT_CLOCK_TOWN_STRAY_FAIRY), "Clock Town Stray Fairy",
                    "Player collected the Clock Town Stray Fairy"),
        EVENT_ENTRY(AE(EVENT_RECEIVED_DON_GERO_MASK), "Received Don Gero Mask", "Player received the Don Gero Mask"),
        EVENT_ENTRY(AE(EVENT_RECEIVED_MOON_TEAR), "Received Moon's Tear", "Player obtained the Moon's Tear"),
        EVENT_ENTRY(AE(EVENT_RECEIVED_PINNACLE_ROCK_HP), "Pinnacle Rock Prize",
                    "Player rescued the seahorses at Pinnacle Rock"),
        EVENT_ENTRY(AE(EVENT_TOWN_ARCHERY_REWARD_1), "Town Archery Reward", "Player cleared the Town Shooting Gallery"),
        EVENT_ENTRY(AE(EVENT_SWAMP_ARCHERY_REWARD_1), "Swamp Archery First Prize",
                    "Player cleared the Swamp Shooting Gallery"),
        EVENT_ENTRY(AE(EVENT_SWAMP_ARCHERY_REWARD_2), "Swamp Archery Second Prize",
                    "Player set a new record at the Swamp Shooting Gallery"),
        EVENT_ENTRY(AE(EVENT_RECEIVED_SWAMP_TITLE_DEED), "Received Swamp Title Deed",
                    "Player obtained the Swamp Title Deed"),
        EVENT_ENTRY(AE(EVENT_LEARNED_SONG_OF_SOARING), "Learned Song of Soaring", "Player learned the Song of Soaring"),
        EVENT_ENTRY(AE(EVENT_SWORDSMAN_SCHOOL_HP), "Swordsman School Prize",
                    "Player earned the Swordsman's School Heart Piece"),
        EVENT_ENTRY(AE(EVENT_BOAT_ARCHERY_HEART_PIECE), "Boat Archery Prize",
                    "Player won the Boat Archery Heart Piece"),
        EVENT_ENTRY(AE(EVENT_RECEIVED_PICTOGRAPH_BOX), "Received Pictograph Box", "Player received the Pictograph Box"),
        EVENT_ENTRY(AE(EVENT_TINGLE_PICTURE_HEART_PIECE), "Tingle's Picture Prize", "Player showed Tingle his picture"),
        EVENT_ENTRY(AE(EVENT_LEARNED_GORON_LULLABY_INTRO), "Learned Goron Lullaby Intro",
                    "Player learned the first half of Goron Lullaby"),
        EVENT_ENTRY(AE(EVENT_BEAVER_RACE_2), "Beaver Race Second Prize", "Player won the second Beaver Race"),
        EVENT_ENTRY(AE(EVENT_BEAVER_RACE_1), "Beaver Race First Prize", "Player won the first Beaver Race"),
        EVENT_ENTRY(AE(EVENT_RECEIVED_RED_POTION), "Received Red Potion", "Player got a Red Potion from Kotake"),
        EVENT_ENTRY(AE(EVENT_RECEIVED_OCEAN_TITLE_DEED), "Received Ocean Title Deed",
                    "Player obtained the Ocean Title Deed"),
        EVENT_ENTRY(AE(EVENT_ZORA_HALL_EVAN_HP), "Zora Hall Evan Reward", "Player received a Heart Piece from Evan")
    };
