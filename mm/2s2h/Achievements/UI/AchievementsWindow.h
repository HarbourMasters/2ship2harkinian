#ifndef ACHIEVEMENTS_UI_ACHIEVEMENTS_WINDOW_H
#define ACHIEVEMENTS_UI_ACHIEVEMENTS_WINDOW_H
...
enum class CardTheme { UNLOCKED, PROGRESS, LOCKED };
} // namespace AchievementsUI
...
class AchievementsWindow : public Ship::GuiWindow {
  ...
  private:
    ...
    int GetAchievementSortPriority(const Achievement* achievement) const;
...
#endif // ACHIEVEMENTS_UI_ACHIEVEMENTS_WINDOW_H