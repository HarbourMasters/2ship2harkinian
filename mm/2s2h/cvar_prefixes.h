#ifndef CVAR_PREFIXES_H
#define CVAR_PREFIXES_H

#define CVAR_RANDOMIZER(var) CVAR_PREFIX_RANDOMIZER "." var
#define CVAR_RANDOMIZER_ENHANCEMENT(var) CVAR_RANDOMIZER("Enhancement." var)
#define CVAR_RANDOMIZER_SETTING(var) CVAR_RANDOMIZER("Setting." var)
...
#define CVAR_TRACKER_TIMESPLITS(var) CVAR_TRACKER("TimeSplitsTracker." var)
