...
typedef enum {
    ...
    COSMETIC_ELEMENT_TRAIL_SWORD_KOKIRI,
    COSMETIC_ELEMENT_TRAIL_SWORD_RAZOR,
    COSMETIC_ELEMENT_TRAIL_SWORD_GILDED,
    COSMETIC_ELEMENT_TRAIL_SWORD_GREAT_FAIRY,
    COSMETIC_ELEMENT_TRAIL_SWORD_FIERCE_DEITY,
    COSMETIC_ELEMENT_TRAIL_DEKU_STICK,
    COSMETIC_ELEMENT_TRAIL_DEKU_SPIN,
    COSMETIC_ELEMENT_TRAIL_ZORA_PUNCH,
    COSMETIC_ELEMENT_TRAIL_ZORA_KICK,
    COSMETIC_ELEMENT_TRAIL_ZORA_BOOMERANG,
