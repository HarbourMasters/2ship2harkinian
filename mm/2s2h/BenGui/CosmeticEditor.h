...
typedef enum {
    ...
    COSMETIC_ELEMENT_KOKIRI_SWORD_TRAIL,
    COSMETIC_ELEMENT_RAZOR_SWORD_TRAIL,
    COSMETIC_ELEMENT_GILDED_SWORD_TRAIL,
    COSMETIC_ELEMENT_GREAT_FAIRY_SWORD_TRAIL,
    COSMETIC_ELEMENT_FIERCE_DEITY_SWORD_TRAIL,
    COSMETIC_ELEMENT_DEKU_STICK_TRAIL,
    COSMETIC_ELEMENT_DEKU_SPIN_TRAIL,
    COSMETIC_ELEMENT_ZORA_PUNCH_TRAIL,
    COSMETIC_ELEMENT_ZORA_KICK_TRAIL,
    COSMETIC_ELEMENT_ZORA_BOOMERANG_TRAIL,
