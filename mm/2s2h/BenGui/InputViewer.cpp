...
void InputViewer::RenderButton(std::string btnTexture, std::string btnOutlineTexture, int state, ImVec2 size,
    ...
    if (outlineMode == BUTTON_OUTLINE_ALWAYS_SHOWN || (outlineMode == BUTTON_OUTLINE_NOT_PRESSED && !state) ||
        ...
        ImGui::Image(
            std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetRawInstance()->GetWindow()->GetGui())
                ->GetTextureByName(btnOutlineTexture), size, ImVec2(0, 0), ImVec2(1.0f, 1.0f));
    }
    ...
    if (state) {
        ...
        ImGui::Image(
            std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetRawInstance()->GetWindow()->GetGui())
                ->GetTextureByName(btnTexture), size, ImVec2(0, 0), ImVec2(1.0f, 1.0f));
    }
}
...
void InputViewer::DrawElement() {
    if (CVarGetInteger("gWindows.InputViewer", 0)) {
        ...
        if (!sButtonTexturesLoaded) {
            std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetRawInstance()->GetWindow()->GetGui())->LoadTextureFromRawImage("Input-Viewer-Background", "textures/buttons/InputViewerBackground.png");
            std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetRawInstance()->GetWindow()->GetGui())->LoadTextureFromRawImage("A-Btn", "textures/buttons/ABtn.png");
            std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetRawInstance()->GetWindow()->GetGui())->LoadTextureFromRawImage("B-Btn", "textures/buttons/BBtn.png");
            std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetRawInstance()->GetWindow()->GetGui())->LoadTextureFromRawImage("L-Btn", "textures/buttons/LBtn.png");
            std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetRawInstance()->GetWindow()->GetGui())->LoadTextureFromRawImage("R-Btn", "textures/buttons/RBtn.png");
            std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetRawInstance()->GetWindow()->GetGui())->LoadTextureFromRawImage("Z-Btn", "textures/buttons/ZBtn.png");
            std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetRawInstance()->GetWindow()->GetGui())->LoadTextureFromRawImage("Start-Btn", "textures/buttons/StartBtn.png");
            std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetRawInstance()->GetWindow()->GetGui())->LoadTextureFromRawImage("C-Left", "textures/buttons/CLeft.png");
            std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetRawInstance()->GetWindow()->GetGui())->LoadTextureFromRawImage("C-Right", "textures/buttons/CRight.png");
            std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetRawInstance()->GetWindow()->GetGui())->LoadTextureFromRawImage("C-Up", "textures/buttons/CUp.png");
            std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetRawInstance()->GetWindow()->GetGui())->LoadTextureFromRawImage("C-Down", "textures/buttons/CDown.png");
            std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetRawInstance()->GetWindow()->GetGui())->LoadTextureFromRawImage("Analog-Stick", "textures/buttons/AnalogStick.png");
            std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetRawInstance()->GetWindow()->GetGui())->LoadTextureFromRawImage("Dpad-Left", "textures/buttons/DPadLeft.png");
            std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetRawInstance()->GetWindow()->GetGui())->LoadTextureFromRawImage("Dpad-Right", "textures/buttons/DPadRight.png");
            std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetRawInstance()->GetWindow()->GetGui())->LoadTextureFromRawImage("Dpad-Up", "textures/buttons/DPadUp.png");
            std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetRawInstance()->GetWindow()->GetGui())->LoadTextureFromRawImage("Dpad-Down", "textures/buttons/DPadDown.png");
            std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetRawInstance()->GetWindow()->GetGui())->LoadTextureFromRawImage("Modifier-1", "textures/buttons/Mod1.png");
            std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetRawInstance()->GetWindow()->GetGui())->LoadTextureFromRawImage("Modifier-2", "textures/buttons/Mod2.png");
            std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetRawInstance()->GetWindow()->GetGui())->LoadTextureFromRawImage("Right-Stick", "textures/buttons/RightStick.png");
            std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetRawInstance()->GetWindow()->GetGui())->LoadTextureFromRawImage("A-Btn Outline", "textures/buttons/ABtnOutline.png");
            std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetRawInstance()->GetWindow()->GetGui())->LoadTextureFromRawImage("B-Btn Outline", "textures/buttons/BBtnOutline.png");
            std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetRawInstance()->GetWindow()->GetGui())->LoadTextureFromRawImage("L-Btn Outline", "textures/buttons/LBtnOutline.png");
            std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetRawInstance()->GetWindow()->GetGui())->LoadTextureFromRawImage("R-Btn Outline", "textures/buttons/RBtnOutline.png");
            std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetRawInstance()->GetWindow()->GetGui())->LoadTextureFromRawImage("Z-Btn Outline", "textures/buttons/ZBtnOutline.png");
            std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetRawInstance()->GetWindow()->GetGui())->LoadTextureFromRawImage("Start-Btn Outline", "textures/buttons/StartBtnOutline.png");
            std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetRawInstance()->GetWindow()->GetGui())->LoadTextureFromRawImage("C-Left Outline", "textures/buttons/CLeftOutline.png");
            std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetRawInstance()->GetWindow()->GetGui())->LoadTextureFromRawImage("C-Right Outline", "textures/buttons/CRightOutline.png");
            std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetRawInstance()->GetWindow()->GetGui())->LoadTextureFromRawImage("C-Up Outline", "textures/buttons/CUpOutline.png");
            std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetRawInstance()->GetWindow()->GetGui())->LoadTextureFromRawImage("C-Down Outline", "textures/buttons/CDownOutline.png");
            std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetRawInstance()->GetWindow()->GetGui())->LoadTextureFromRawImage("Analog-Stick Outline", "textures/buttons/AnalogStickOutline.png");
            std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetRawInstance()->GetWindow()->GetGui())->LoadTextureFromRawImage("Dpad-Left Outline", "textures/buttons/DPadLeftOutline.png");
            std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetRawInstance()->GetWindow()->GetGui())->LoadTextureFromRawImage("Dpad-Right Outline", "textures/buttons/DPadRightOutline.png");
            std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetRawInstance()->GetWindow()->GetGui())->LoadTextureFromRawImage("Dpad-Up Outline", "textures/buttons/DPadUpOutline.png");
            std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetRawInstance()->GetWindow()->GetGui())->LoadTextureFromRawImage("Dpad-Down Outline", "textures/buttons/DPadDownOutline.png");
            std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetRawInstance()->GetWindow()->GetGui())->LoadTextureFromRawImage("Modifier-1 Outline", "textures/buttons/Mod1Outline.png");
            std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetRawInstance()->GetWindow()->GetGui())->LoadTextureFromRawImage("Modifier-2 Outline", "textures/buttons/Mod2Outline.png");
            std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetRawInstance()->GetWindow()->GetGui())->LoadTextureFromRawImage("Right-Stick Outline", "textures/buttons/RightStickOutline.png");
...
#endif
        const int showLeftAnalogAngles = CVarGetInteger(CVAR_INPUT_VIEWER("LeftAnalogAngles.Enabled"), 0);
        const int showRightAnalogAngles = CVarGetInteger(CVAR_INPUT_VIEWER("RightAnalogAngles.Enabled"), 0);
        ...
        ImVec2 bgSize = std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetRawInstance()->GetWindow()->GetGui())->GetTextureSize("Input-Viewer-Background");
        ...
        float maxScale = std::max(CVarGetFloat(CVAR_INPUT_VIEWER("LeftAnalogAngles.Scale"), 1.0f),
                                  CVarGetFloat(CVAR_INPUT_VIEWER("RightAnalogAngles.Scale"), 1.0f));

        if (showLeftAnalogAngles || showRightAnalogAngles) {

            ImGui::SetNextWindowSize(
                ImVec2(scaledBGSize.x + 20, scaledBGSize.y +
                                                (showLeftAnalogAngles || showRightAnalogAngles
                                                     ? ImGui::CalcTextSize("X").y * scale * maxScale
                                                     : 0) +
                                                20));
        ...
        if (pads != nullptr && ImGui::Begin("Input Viewer", nullptr, windowFlags)) {
            ...
            if (CVarGetInteger(CVAR_INPUT_VIEWER("BBtn"), 1)) {
                ...
                RenderButton("B-Btn", "B-Btn Outline", pad.button & BTN_B, scaledBGSize,
            ...
            if (CVarGetInteger(CVAR_INPUT_VIEWER("ABtn"), 1)) {
                ImGui::SetNextItemAllowOverlap();
                ImGui::SetCursorPos(aPos);
                RenderButton("A-Btn", "A-Btn Outline", pad.button & BTN_A, scaledBGSize,
                             useGlobalOutlineMode
                                 ? buttonOutlineMode
            ...
            if (CVarGetInteger(CVAR_INPUT_VIEWER("CUp"), 1)) {
                ImGui::SetNextItemAllowOverlap();
                ImGui::SetCursorPos(aPos);
                RenderButton("C-Up", "C-Up Outline", pad.button & BTN_CUP, scaledBGSize,
                             useGlobalOutlineMode
                                 ? buttonOutlineMode
            ...
            if (CVarGetInteger(CVAR_INPUT_VIEWER("CLeft"), 1)) {
                ImGui::SetNextItemAllowOverlap();
                ImGui::SetCursorPos(aPos);
                RenderButton("C-Left", "C-Left Outline", pad.button & BTN_CLEFT, scaledBGSize,
                             useGlobalOutlineMode
                                 ? buttonOutlineMode
            ...
            if (CVarGetInteger(CVAR_INPUT_VIEWER("CRight"), 1)) {
                ImGui::SetNextItemAllowOverlap();
                ImGui::SetCursorPos(aPos);
                RenderButton("C-Right", "C-Right Outline", pad.button & BTN_CRIGHT, scaledBGSize,
                             useGlobalOutlineMode
                                 ? buttonOutlineMode
            ...
            if (CVarGetInteger(CVAR_INPUT_VIEWER("CDown"), 1)) {
                ImGui::SetNextItemAllowOverlap();
                ImGui::SetCursorPos(aPos);
                RenderButton("C-Down", "C-Down Outline", pad.button & BTN_CDOWN, scaledBGSize,
                             useGlobalOutlineMode
                                 ? buttonOutlineMode
            ...
            if (CVarGetInteger(CVAR_INPUT_VIEWER("LBtn"), 1)) {
                ImGui::SetNextItemAllowOverlap();
                ImGui::SetCursorPos(aPos);
                RenderButton("L-Btn", "L-Btn Outline", pad.button & BTN_L, scaledBGSize,
                             useGlobalOutlineMode
                                 ? buttonOutlineMode
            ...
            if (CVarGetInteger(CVAR_INPUT_VIEWER("RBtn"), 1)) {
                ImGui::SetNextItemAllowOverlap();
                ImGui::SetCursorPos(aPos);
                RenderButton("R-Btn", "R-Btn Outline", pad.button & BTN_R, scaledBGSize,
                             useGlobalOutlineMode
                                 ? buttonOutlineMode
            ...
            if (CVarGetInteger(CVAR_INPUT_VIEWER("ZBtn"), 1)) {
                ImGui::SetNextItemAllowOverlap();
                ImGui::SetCursorPos(aPos);
                RenderButton("Z-Btn", "Z-Btn Outline", pad.button & BTN_Z, scaledBGSize,
                             useGlobalOutlineMode
                                 ? buttonOutlineMode
            ...
            if (CVarGetInteger(CVAR_INPUT_VIEWER("StartBtn"), 1)) {
                ImGui::SetNextItemAllowOverlap();
                ImGui::SetCursorPos(aPos);
                RenderButton("Start-Btn", "Start-Btn Outline", pad.button & BTN_START, scaledBGSize,
            ...
            if (CVarGetInteger(CVAR_INPUT_VIEWER("Dpad"), 0)) {
                ImGui::SetNextItemAllowOverlap();
                ImGui::SetCursorPos(aPos);
                RenderButton("Dpad-Left", "Dpad-Left Outline", pad.button & BTN_DLEFT, scaledBGSize,
                             useGlobalOutlineMode
                                 ? buttonOutlineMode
                                 : CVarGetInteger(CVAR_INPUT_VIEWER("DpadOutlineMode"), BUTTON_OUTLINE_NOT_PRESSED));
                ImGui::SetNextItemAllowOverlap();
                ImGui::SetCursorPos(aPos);
                RenderButton("Dpad-Right", "Dpad-Right Outline", pad.button & BTN_DRIGHT, scaledBGSize,
                             useGlobalOutlineMode
                                 ? buttonOutlineMode
                                 : CVarGetInteger(CVAR_INPUT_VIEWER("DpadOutlineMode"), BUTTON_OUTLINE_NOT_PRESSED));
                ImGui::SetNextItemAllowOverlap();
                ImGui::SetCursorPos(aPos);
                RenderButton("Dpad-Up", "Dpad-Up Outline", pad.button & BTN_DUP, scaledBGSize,
                             useGlobalOutlineMode
                                 ? buttonOutlineMode
                                 : CVarGetInteger(CVAR_INPUT_VIEWER("DpadOutlineMode"), BUTTON_OUTLINE_NOT_PRESSED));
                ImGui::SetNextItemAllowOverlap();
                ImGui::SetCursorPos(aPos);
                RenderButton("Dpad-Down", "Dpad-Down Outline", pad.button & BTN_DDOWN, scaledBGSize,
                             useGlobalOutlineMode
                                 ? buttonOutlineMode
                                 : CVarGetInteger(CVAR_INPUT_VIEWER("DpadOutlineMode"), BUTTON_OUTLINE_NOT_PRESSED));
            }
            ...
            if (CVarGetInteger(CVAR_INPUT_VIEWER("Mod1"), 0)) {
                ImGui::SetNextItemAllowOverlap();
                ImGui::SetCursorPos(aPos);
                RenderButton("Modifier-1", "Modifier-1 Outline", pad.button & BTN_CUSTOM_MODIFIER1, scaledBGSize,
                             useGlobalOutlineMode
                                 ? buttonOutlineMode
            ...
            if (CVarGetInteger(CVAR_INPUT_VIEWER("Mod2"), 0)) {
                ImGui::SetNextItemAllowOverlap();
                ImGui::SetCursorPos(aPos);
                RenderButton("Modifier-2", "Modifier-2 Outline", pad.button & BTN_CUSTOM_MODIFIER2, scaledBGSize,
                             useGlobalOutlineMode
                                 ? buttonOutlineMode
                                 : CVarGetInteger(CVAR_INPUT_VIEWER("Mod2OutlineMode"), BUTTON_OUTLINE_NOT_PRESSED));
            }

            const bool analogStickIsInDeadzone = !pad.stick_x && !pad.stick_y;
            const bool rightStickIsInDeadzone = !pad.right_stick_x && !pad.right_stick_y;
            ...
            if (showLeftAnalogAngles) {
                ...
                const int32_t rSquared = pad.stick_x * pad.stick_x + pad.stick_y * pad.stick_y;

                // ESS range
                const int range1Min = CVarGetInteger(CVAR_INPUT_VIEWER("LeftAnalogAngles.Range1.Min"), 8);
                const int range1Max = CVarGetInteger(CVAR_INPUT_VIEWER("LeftAnalogAngles.Range1.Max"), 27);
                // Walking speed range
                const int range2Min = CVarGetInteger(CVAR_INPUT_VIEWER("LeftAnalogAngles.Range2.Min"), 27);
                const int range2Max = CVarGetInteger(CVAR_INPUT_VIEWER("LeftAnalogAngles.Range2.Max"), 62);
                ...
                if (CVarGetInteger(CVAR_INPUT_VIEWER("LeftAnalogAngles.Range1.Enabled"), 0) &&
                    ...
                    ImGui::PushStyleColor(ImGuiCol_Text, VecFromRGBA8(CVarGetColor(
                                                             CVAR_INPUT_VIEWER("LeftAnalogAngles.Range1.Color.Value"),
                                                             range1ColorDefault)));
                } else if (CVarGetInteger(CVAR_INPUT_VIEWER("LeftAnalogAngles.Range2.Enabled"), 0) &&
                           (rSquared >= (range2Min * range2Min)) && (rSquared < (range2Max * range2Max))) {
                    ImGui::PushStyleColor(ImGuiCol_Text, VecFromRGBA8(CVarGetColor(
                                                             CVAR_INPUT_VIEWER("LeftAnalogAngles.Range2.Color.Value"),
                                                             range2ColorDefault)));
                } else {
                    ImGui::PushStyleColor(
                        ImGuiCol_Text, VecFromRGBA8(CVarGetColor(CVAR_INPUT_VIEWER("LeftAnalogAngles.TextColor.Value"),
                                                                 textColorDefault)));
                }

                // Render text
                ImGui::Text("Left: X:%-3d Y:%-3d", pad.stick_x, pad.stick_y);
            ...
            if (showRightAnalogAngles) {
                ...
                ImGui::PushStyleColor(ImGuiCol_Text,
                                      VecFromRGBA8(CVarGetColor(CVAR_INPUT_VIEWER("RightAnalogAngles.TextColor.Value"),
                                                                textColorDefault)));

                // Render text
                ImGui::Text("Right: X:%-3d Y:%-3d", pad.right_stick_x, pad.right_stick_y);
                // Restore original font scale
                ImGui::GetFont()->Scale = oldFontScale;
                ImGui::PopStyleColor();
                ImGui::PopFont();
...
void InputViewerSettingsWindow::DrawElement() {
    ...
    if (ImGui::CollapsingHeader("Left Analog Angle Values")) {
        // gInputViewer.LeftAnalogAngles
        CVarCheckbox(
            "Show Left Analog Stick Angle Values", CVAR_INPUT_VIEWER("LeftAnalogAngles.Enabled"),
        ...
        if (CVarGetInteger(CVAR_INPUT_VIEWER("LeftAnalogAngles.Enabled"), 0)) {
            ...
            CVarSliderFloat("LS Angle Text Scale: %.2f%%", CVAR_INPUT_VIEWER("LeftAnalogAngles.Scale"),
                            FloatSliderOptions()
                                ...
                                .DefaultValue(1.0f)
                                .ShowAdjustmentButtons(true));
            // gInputViewer.LeftAnalogAngles.HortizontalOffset
            CVarSliderInt("LS Angle Text Hortizontal Offset: %dpx",
                          CVAR_INPUT_VIEWER("LeftAnalogAngles.HortizontalOffset"),
                          IntSliderOptions()
                              .Color(THEME_COLOR)
                              .Min(0)
                              .Max(188)
                              .DefaultValue(0)
                              .ShowAdjustmentButtons(true)
                              .Tooltip("Sets the hortizontal offset of the text."));
            // gInputViewer.LeftAnalogAngles.VerticalOffset
            CVarSliderInt("LS Angle Text Vertical Offset: %dpx", CVAR_INPUT_VIEWER("LeftAnalogAngles.VerticalOffset"),
                          IntSliderOptions()
                              .Color(THEME_COLOR)
                              .Min(0)
                              .Max(173)
                              .DefaultValue(173)
                              .ShowAdjustmentButtons(true)
                              .Tooltip("Sets the vertical offset of the text."));
            UIWidgets::PaddedSeparator(true, true);
            // gInputViewer.LeftAnalogAngles.Range1.Enabled
            CVarCheckbox(
                "Highlight ESS Position", CVAR_INPUT_VIEWER("LeftAnalogAngles.Range1.Enabled"),
                CheckboxOptions()
                    .Color(THEME_COLOR)
                    .Tooltip(
            ...
            UIWidgets::PaddedSeparator(true, true);
            // gInputViewer.LeftAnalogAngles.Range2.Enabled
            CVarCheckbox("Highlight Walking Speed Angles", CVAR_INPUT_VIEWER("LeftAnalogAngles.Range2.Enabled"),
                         CheckboxOptions()
                             .Color(THEME_COLOR)
    ...
    if (ImGui::CollapsingHeader("Right Analog Angle Values")) {
        // gInputViewer.RightAnalogAngles
        CVarCheckbox(
            "Show Right Analog Stick Angle Values", CVAR_INPUT_VIEWER("RightAnalogAngles.Enabled"),
            CheckboxOptions().Color(THEME_COLOR).Tooltip("Displays analog stick angle values in the input viewer"));
        if (CVarGetInteger(CVAR_INPUT_VIEWER("RightAnalogAngles.Enabled"), 0)) {
            ...
            CVarSliderFloat("RS Angle Text Scale: %.2f%%", CVAR_INPUT_VIEWER("RightAnalogAngles.Scale"),
                            FloatSliderOptions()
                                ...
                                .DefaultValue(1.0f)
                                .ShowAdjustmentButtons(true));
            // gInputViewer.RightAnalogAngles.HortizontalOffset
            CVarSliderInt("RS Angle Text Hortizontal Offset: %dpx",
                          CVAR_INPUT_VIEWER("RightAnalogAngles.HortizontalOffset"),
                          IntSliderOptions()
                              .Color(THEME_COLOR)
                              .Min(0)
                              .Max(188)
                              ...
                              .Tooltip("Sets the hortizontal offset of the text."));
            // gInputViewer.LeftAnalogAngles.VerticalOffset
            CVarSliderInt("RS Angle Text Vertical offset: %dpx", CVAR_INPUT_VIEWER("RightAnalogAngles.VerticalOffset"),
                          IntSliderOptions()
                              .Color(THEME_COLOR)
                              .Min(0)
                              .Max(173)
