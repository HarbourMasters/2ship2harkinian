...
void BenMenu::AddEnhancements() {
    ...
    AddWidget(path, "Easy Mask Equip", WIDGET_CVAR_CHECKBOX)
        ...
        .Options(CheckboxOptions().Tooltip("Allows you to equip transformation masks directly from the pause menu by pressing A."));
...
void BenMenu::InitElement() {
    ...
    disabledMap = {
        ...
        { DISABLE_FOR_LOW_RES_MODE_ON,
          { [](disabledInfo& info) -> bool { return CVarGetInteger("gSettings.Graphics.LowResMode", 0); },
            "Low Resolution Mode is Enabled" } },
        { DISABLE_FOR_FAST_TRANSFORMATION_OFF,
          { [](disabledInfo& info) -> bool { return !CVarGetInteger("gEnhancements.Masks.FastTransformation", 0); },
            "Fast Transformation is Required" } },
    };
}
