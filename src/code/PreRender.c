...
void Prerender_DrawBackground2D(Gfx** gfxp, TexturePtr timg, TexturePtr tlut, u16 width, u16 height, u8 fmt, u8 siz,
                                u16 tt, u16 arg8, f32 x, f32 y, f32 xScale, f32 yScale, u32 flags) {
