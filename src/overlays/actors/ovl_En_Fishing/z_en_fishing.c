...
void EnFishing_Init(Actor* thisx, GlobalContext* globalCtx2) {
    ...
    if (thisx->params < 100) {
        ...
        if (sLinkAge != 1) {
            ...
            if (gSaveContext.save.roomInf[127][2] & 0x1000) {
                D_8090CD08 = 0;
            } else {
                D_8090CD08 = 1;
            }
        ...
        if (sLinkAge == 1) {
            if (gSaveContext.save.roomInf[127][2] & 0x7F) {
                D_809171CC = gSaveContext.save.roomInf[127][2] & 0x7F;
            } else {
                D_809171CC = 40.0f;
            }
        } else if (gSaveContext.save.roomInf[127][2] & 0x7F000000) {
            D_809171CC = (gSaveContext.save.roomInf[127][2] & 0x7F000000) >> 0x18;
        } else {
            D_809171CC = 45.0f;
        }

        D_809171D1 = (gSaveContext.save.roomInf[127][2] & 0xFF0000) >> 0x10;
        if ((D_809171D1 & 7) == 7) {
...
void EnFishing_HandleAquariumDialog(EnFishing* this, GlobalContext* globalCtx) {
    if (sLinkAge == 1) {
        if (gSaveContext.save.roomInf[127][2] & 0x7F) {
            if (gSaveContext.save.roomInf[127][2] & 0x80) {
        ...
        if (gSaveContext.save.roomInf[127][2] & 0x80000000) {
            this->actor.textId = 0x40B1;
        } else {
            this->actor.textId = 0x4089;
        }
        ...
        case 5:
            ...
            if ((D_8090CD14 < 3) || ((D_809171C8 != 0) && (D_809171D4 > 50)) || (D_809171D4 >= 6000) ||
                ...
                if ((D_80917272 == 0) && (D_80917274 == 0)) {
                    ...
                    if (((sLinkAge == 1) && (gSaveContext.save.roomInf[127][2] & 0x400)) ||
                        ((sLinkAge != 1) && (gSaveContext.save.roomInf[127][2] & 0x800))) {
...
void EnFishing_HandleOwnerDialog(EnFishing* this, GlobalContext* globalCtx) {
    switch (this->unk_154) {
        case 0:
            if (D_809171FC == 0) {
                if (sLinkAge != 1) {
                    if ((gSaveContext.save.roomInf[127][2] & 0x100) && !(gSaveContext.save.roomInf[127][2] & 0x200)) {
            ...
            if (Actor_ProcessTalkRequest(&this->actor, &globalCtx->state)) {
                if (D_809171FC == 0) {
                    this->unk_154 = 1;
                    if (sLinkAge != 1) {
                        gSaveContext.save.roomInf[127][2] |= 0x200;
                    } else {
                        gSaveContext.save.roomInf[127][2] |= 0x100;
                    }
                } else {
                    this->unk_154 = 10;
                }
        ...
        case 5:
            if ((Message_GetState(&globalCtx->msgCtx) == 5) && func_80147624(globalCtx)) {
                ...
                if ((gSaveContext.save.roomInf[127][2] & 0xFF0000) < 0xFF0000) {
                    gSaveContext.save.roomInf[127][2] += 0x10000;
                }
            }
            break;
            ...
            if (((Message_GetState(&globalCtx->msgCtx) == 5) || !Message_GetState(&globalCtx->msgCtx)) &&
                ...
                if (D_809171D0 == 0) {
                    ...
                    if (sLinkAge == 1) {
                        ...
                        gSaveContext.save.roomInf[127][2] &= 0xFFFFFF00;
                        gSaveContext.save.roomInf[127][2] |= ((s16)D_809171CC & 0x7F);

                        temp = (gSaveContext.save.roomInf[127][2] & 0x7F000000) >> 0x18;
                        if (temp < D_809171CC) {
                            gSaveContext.save.roomInf[127][2] &= 0xFFFFFF;
                            gSaveContext.save.roomInf[127][2] |= ((s16)D_809171CC & 0x7F) << 0x18;

                            if (D_809171D2 == 2) {
                                gSaveContext.save.roomInf[127][2] |= 0x80000000;
                            }
                        }

                        if (D_809171D2 == 2) {
                            gSaveContext.save.roomInf[127][2] |= 0x80;
                            this->unk_154 = 0;
                            break;
                        }
                    } else {
                    ...
                    if (sLinkAge == 1) {
                        if ((D_809171CC >= 50.0f) && !(gSaveContext.save.roomInf[127][2] & 0x400)) {
                            gSaveContext.save.roomInf[127][2] |= 0x400;
                            getItemId = GI_HEART_PIECE;
                            sSinkingLureLocation = Rand_ZeroFloat(3.999f) + 1.0f;
                        }
                    } else {
                        if ((D_809171CC >= 60.0f) && !(gSaveContext.save.roomInf[127][2] & 0x800)) {
                            gSaveContext.save.roomInf[127][2] |= 0x800;
...
void EnFishing_UpdateOwner(Actor* thisx, GlobalContext* globalCtx2) {
    ...
    if (D_8090CD08 == 0) {
        gSaveContext.save.roomInf[127][2] |= 0x1000;
