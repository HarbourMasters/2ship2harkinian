...
MtxF sAlienLeftEyeBeamMtxF_2;
MtxF sAlienRightEyeBeamMtxF_2;
...
void EnInvadepohDemo_Alien_PostLimbDraw(PlayState* play, s32 limbIndex, Gfx** dList, Vec3s* rot, Actor* thisx,
    ...
    if (limbIndex == ALIEN_LIMB_LEFT_EYE) {
        ...
        Matrix_Get(&sAlienLeftEyeBeamMtxF_2);
        Matrix_Pop();
        ...
        Matrix_Scale(1.0f, 1.0f, 1.5f, MTXMODE_APPLY);
        Matrix_Get(&sAlienRightEyeBeamMtxF_2);
        Matrix_Pop();
    }
}
...
void EnInvadepohDemo_Alien_Draw(EnInvadepohDemo* this, PlayState* play) {
    ...
    if (true) {
        ...
        Matrix_Mult(&sAlienLeftEyeBeamMtxF_2, MTXMODE_NEW);
        ...
        if (mtx != NULL) {
            ...
            Matrix_Mult(&sAlienRightEyeBeamMtxF_2, MTXMODE_NEW);
