...
void func_808B9CE8(DoorWarp1* this, GlobalContext* globalCtx) {
    ...
    switch (globalCtx->sceneNum) {
        case SCENE_MITURIN_BS:
            gSaveContext.save.roomInf[126][3] = (((void)0, gSaveContext.save.roomInf[126][3]) & 0xFFFFFF00) |
                                                (((u8)gSaveContext.save.roomInf[126][4]) & 0xFF);
            break;

        case SCENE_HAKUGIN_BS:
            gSaveContext.save.roomInf[126][3] = (((void)0, gSaveContext.save.roomInf[126][3]) & 0xFFFF00FF) |
                                                ((((u8)gSaveContext.save.roomInf[126][4]) & 0xFF) << 8);
            break;

        case SCENE_INISIE_BS:
            gSaveContext.save.roomInf[126][3] = (((void)0, gSaveContext.save.roomInf[126][3]) & 0xFF00FFFF) |
                                                ((((u8)gSaveContext.save.roomInf[126][4]) & 0xFF) << 0x10);
            break;

        case SCENE_SEA_BS:
            gSaveContext.save.roomInf[126][3] = (((void)0, gSaveContext.save.roomInf[126][3]) & 0x00FFFFFF) |
                                                ((((u8)gSaveContext.save.roomInf[126][4]) & 0xFF) << 0x18);
            break;
    }

    gSaveContext.save.roomInf[126][4] =
        (gSaveContext.save.roomInf[126][4] & 0xFFFFFF00) | ((((u8)gSaveContext.save.roomInf[126][4]) + 1) & 0xFF);
...
void func_808BA10C(DoorWarp1* this, GlobalContext* globalCtx) {
    ...
    if ((globalCtx->sceneNum == SCENE_MITURIN_BS) || (globalCtx->sceneNum == SCENE_HAKUGIN_BS) ||
        ...
        if (this->unk_202 != 0) {
            ...
            switch (phi_v0_2) {
                case 0:
                    phi_a0 = gSaveContext.save.roomInf[126][3] & 0xFF;
                    break;

                case 1:
                    phi_a0 = (gSaveContext.save.roomInf[126][3] & 0xFF00) >> 8;
                    break;

                case 2:
                    phi_a0 = (gSaveContext.save.roomInf[126][3] & 0xFF0000) >> 0x10;
                    break;

                case 3:
                    phi_a0 = (gSaveContext.save.roomInf[126][3] & 0xFF000000) >> 0x18;
                    break;
