...
s8 func_80997A90(s16 arg0, s16 arg1) {
    ...
    if ((arg0 == 0) || ((arg0 != 1) && (arg0 != 2) && (arg0 == 3))) {
        ...
        phi_v1 = (gSaveContext.save.roomInf[126][1] >> (arg1 * 3)) & 7;
    }
    return phi_v1;
}
...
void func_809985B8(EnGs* this, GlobalContext* globalCtx) {
    ...
    if (func_8013E2D4(&this->actor, this->unk_212, -1, 0)) {
        ...
        this->unk_200 = 0.0f;
        gSaveContext.save.roomInf[126][1] =
            (gSaveContext.save.roomInf[126][1] & ~(7 << (this->unk_198 * 3))) | ((this->unk_194 & 7) << (this->unk_198 * 3));
        gossipStone = NULL;
...
void func_8099874C(EnGs* this, GlobalContext* globalCtx) {
    ...
    if (phi_v0 == 0) {
        ...
        if ((this->unk_19C == 5) && (this->unk_194 != 0)) {
            ...
            for (i = 0; i < 4; i++) {
                if (((gSaveContext.save.roomInf[126][1] >> (i * 3)) & 7) != (u32)this->unk_194) {
                    phi_v0 = 0;
                }
            }
