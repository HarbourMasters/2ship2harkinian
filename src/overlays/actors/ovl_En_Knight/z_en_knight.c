...
void func_809B22CC(EnKnight* this, PlayState* play, u8 arg2) {
    ...
    if (!(this->unk146 & arg2) && this->unk162 == 0 &&
        (this->unk2A4 > 1.0f || this->unk2A8 > 1.0f || arg2 == 0 || this->actor.speedXZ > 1.0f)) {
        for (i = 0; i < 2; i++) {
            ...
            acc.y = -0.1f;
            acc.x = acc.z = 0.0f;
            pos.x = this->unk2AC[i].x + randPlusMinusPoint5Scaled(10.0f);
            pos.y = (Rand_ZeroFloat(5.0f) + this->actor.floorHeight) - 5.0f;
            pos.z = this->unk2AC[i].z + randPlusMinusPoint5Scaled(10.0f);
...
void EnKnight_Init(Actor* thisx, PlayState* play) {
    ...
    if (this->actor.params == 0x64) {
        ...
        if ((gSaveContext.eventInf[5] & 0x80) && !Flags_GetClear(play, play->roomCtx.currRoom.num)) {
            if (this == D_809BEFD0) {
...
void func_809B33F0(EnKnight* this, PlayState* play) {
    ...
    if (Animation_OnFrame(&this->unk194, 1.0f)) {
        Actor_PlaySfxAtPos(&this->actor, this->unk6BC);
    }
...
void func_809B3DAC(EnKnight* this, PlayState* play) {
    ...
    if (this->unk14A[0] != 0) {
        ...
        if (this == D_809BEFD0 && Rand_ZeroOne() < 0.4f) {
            Actor_PlaySfxAtPos(&this->actor, NA_SE_EN_BOSU_CYNICAL);
        }
    }
    this->unk192 = 1;
}
...
void func_809B3F0C(EnKnight* this, PlayState* play) {
    ...
    if (ABS_ALT(temp_v1) < var_a0) {
        ...
        if (!(this->unk146 & 7) && Rand_ZeroOne() < 0.75f) {
            this->unk186 = randPlusMinusPoint5Scaled(28672.0f);
        }
        if (this->unk14A[0] == 0) {
...
void func_809B4308(EnKnight* this, PlayState* play) {
    ...
    if (!(this->unk146 & 0x3F) && Rand_ZeroOne() < 0.5f) {
        if (Rand_ZeroOne() < 0.6666f) {
            Actor_PlaySfxAtPos(&this->actor, this->unk6B6);
        } else {
            Actor_PlaySfxAtPos(&this->actor, this->unk6B8);
        }
    }
        ...
        case 0:
            ...
            if (this->unk292 != 0 && ((D_809BEFE4 != NULL && D_809BEFE4->unk_214 < 0.1f) ||
                ...
                if (this->unk291 != 0) {
                    ...
                    Actor_PlaySfxAtPos(&this->actor, NA_SE_EN_STAL_FREEZE_LIGHTS);
                } else {
                    this->unk148 = 1;
                    Animation_MorphToLoop(&this->unk194, &D_060040E0, -5.0f);
                    this->unk1D8 = 1000.0f;
...
void func_809B5634(EnKnight* this, PlayState* play) {
    ...
    Audio_PlaySfxAtPos(&this->unk6C8, this->unk6C2);
}
...
void func_809B5698(EnKnight* this, PlayState* play) {
    ...
    if (this->unk14A[2] != 0) {
        ...
        sp44 = D_809BDAF0;
        sp44.y = 0.03f;
        sp38.x = this->unk1DC[sp36].x + randPlusMinusPoint5Scaled(20.0f);
        sp38.y = this->unk1DC[sp36].y - 5.0f;
        sp38.z = this->unk1DC[sp36].z + randPlusMinusPoint5Scaled(20.0f);
...
void func_809B58D4(EnKnight* this, PlayState* play) {
    if (this == D_809BEFD0 && this->unk14A[0] == 0) {
        ...
        Actor_MarkForDeath(&D_809BEFD4->actor);
        Actor_MarkForDeath(&D_809BEFD8->actor);
    }
}
...
void func_809B59FC(EnKnight* this, PlayState* play) {
    ...
    Actor_PlaySfxAtPos(&this->actor, NA_SE_EN_MIBOSS_JUMP1);
    this->unk148 = 1;
    this->unk156 = 0x14;
}
...
void func_809B5B08(EnKnight* this, PlayState* play) {
    ...
    if (this == D_809BEFD0) {
        ...
        if (this->unk156 == 0xD) {
            if (this->unk148 == 1) {
                Actor_PlaySfxAtPos(&this->actor, NA_SE_EN_BOSU_LAUGH_DEMO);
            } else {
                Actor_PlaySfxAtPos(&this->actor, NA_SE_EN_BOSU_CYNICAL);
            }
        }
...
void func_809B5D54(EnKnight* this, PlayState* play) {
    ...
    switch (this->unk148) {
        ...
        case 1:
            ...
            Actor_PlaySfxAtPos(&this->actor, NA_SE_EN_BOSU_STAND);
        ...
        case 2:
            if (this->unk14A[0] == 1) {
                if (this->unk290 == 0) {
                    Actor_PlaySfxAtPos(&this->actor, NA_SE_EN_BOSU_SHOCK);
                } else {
                    Actor_PlaySfxAtPos(&this->actor, NA_SE_EN_BOSU_SHIT);
                }
            }
            if (this->unk_151 == 0) {
                func_809B6528(this, play);
...
void func_809B601C(EnKnight* this, PlayState* play) {
    ...
    switch (this->unk148) {
        case 0:
            ...
            break;
        case 1:
            this->actor.speedXZ = KREG(38) + 1.0f;
...
void func_809B6574(PlayState* play, u8 arg1) {
    ...
    for (var_s1 = 0; var_s1 < arg1; var_s1++) {
        ...
        sp98.x = sp98.z = 0.0f;
        sp98.y = -0.1f;
        spB0.x = player->actor.world.pos.x + randPlusMinusPoint5Scaled(30.0f);
        spB0.y = player->actor.world.pos.y + 20.0f + randPlusMinusPoint5Scaled(30.0f);
        spB0.z = player->actor.world.pos.z + randPlusMinusPoint5Scaled(30.0f);
...
void func_809B6764(EnKnight* this, PlayState* play) {
    ...
    if (sp54 != 0) {
        ...
        Actor_PlaySfxAtPos(&this->actor, NA_SE_EV_BLOCK_SHAKE);
    }
}
...
void func_809B6C54(EnKnight* this, PlayState* play) {
    ...
    if (Animation_OnFrame(&this->unk194, 19.0f)) {
        ...
        Actor_PlaySfxAtPos(&this->actor, NA_SE_EN_BOSU_HEAD_SHORT);
    }
    Math_ApproachZeroF(&this->actor.speedXZ, 1.0f, 1.0f);
    if (this->unk14A[0] == 0) {
        func_809B3E9C(this, play);
    ...
    switch (this->unk148) {
        ...
        case 2:
            if (this->unk14A[0] == 0x22) {
                this->unk162 = 0;
                Actor_MarkForDeath(&D_809BEFDC->actor);
                D_809BEFDC = NULL;
                this->actor.flags |= 1;
...
void func_809B71DC(EnKnight* this, PlayState* play) {
    ...
    switch (this->unk688) {
        case 0:
            ...
            Play_CameraChangeStatus(play, this->unk_68A, 7);
            this->actor.flags &= ~1;
            this->unk684 = 0;
            this->unk688 = 1;
        ...
        case 2:
            ...
            if (this->unk684 == (u32)(sREG(69) + 0x32)) {
                ...
                Actor_PlaySfxAtPos(&this->actor, NA_SE_EN_BOSU_ATTACK_K);
            }
            if (this->unk684 >= (u32)(sREG(69) + 0x32)) {
    ...
    if (this->unk_68A != 0) {
        ...
        Play_CameraSetAtEye(play, this->unk_68A, &this->unk698, &this->unk68C);
        Play_CameraSetFov(play, this->unk_68A, this->unk6B0);
    }
}
    ...
    switch (this->unk688) {
        ...
        case 3:
            if (this->unk684 == 7) {
                if (this->unk424 == func_809B6764) {
                    ...
                    Actor_PlaySfxAtPos(&this->actor, NA_SE_EN_BOSU_STAND_RAPID);
                } else {
            ...
            if (Animation_OnFrame(&this->unk194, this->unk1D8) != 0) {
                ...
                this->unk1D8 = 1000.0f;
                Actor_PlaySfxAtPos(&this->actor, NA_SE_EN_BOSU_HAND);
            }
        ...
        case 4:
            ...
            if ((this->unk684 >= 0x9D) && (this->unk684 < 0xDD)) {
                if (!(this->unk684 & 1)) {
                    Actor_PlaySfxAtPos(&this->actor, NA_SE_EN_BOSU_WALK);
                }
                if (!(this->unk684 & 3)) {
                    Actor_PlaySfxAtPos(&this->actor, NA_SE_EN_BOSU_SIT);
                }
            }
...
void func_809B8458(EnKnight* this, PlayState* play) {
    ...
    switch (this->unk688) {
        case 0:
            if (Flags_GetClear(play, play->roomCtx.currRoom.num) || (ActorCutscene_GetCurrentIndex() != -1) ||
        ...
        case 1:
            ...
            if (this->unk684 >= (u32)(BREG(22) + 0x14)) {
                sp64 = 0.5f;
                play_sound(NA_SE_EV_EARTHQUAKE - SFX_FLAG);
            }
        ...
        case 5:
            ...
            if ((this->unk684 == (u32)(BREG(72) + 0xA)) || (this->unk684 == (u32)(BREG(73) + 0x19)) ||
                ...
                Actor_PlaySfxAtPos(&D_809BEFD8->actor, D_809BEFD8->unk6B4);
            }
            ...
            if (this->unk684 == (u32)(BREG(35) + 0x2D)) {
                ...
                Actor_PlaySfxAtPos(&D_809BEFD8->actor, NA_SE_EN_DEBU_PAUSE_K);
            }
        ...
        case 6:
            if ((this->unk684 == (u32)(BREG(72) + 0xA)) || (this->unk684 == (u32)(BREG(73) + 0x19)) ||
                (this->unk684 == (u32)(BREG(74) + 0x28))) {
                Actor_PlaySfxAtPos(&D_809BEFD4->actor, D_809BEFD4->unk6B4);
            }
            ...
            if (this->unk684 == (u32)(BREG(35) + 0x2D)) {
                ...
                Actor_PlaySfxAtPos(&D_809BEFD4->actor, NA_SE_EN_YASE_PAUSE_K);
            }
            if (this->unk684 != (u32)(BREG(33) + 0x50)) {
                break;
            }
        ...
        case 7:
            ...
            if (this->unk684 == (u32)(BREG(37) + 0x19)) {
                Actor_PlaySfxAtPos(&this->actor, NA_SE_EN_BOSU_HAND);
                Actor_PlaySfxAtPos(&this->actor, NA_SE_EN_BOSU_ATTACK);
            }
        ...
        case 8:
            ...
            if (this->unk684 == 0x0000001E) {
                ...
                Actor_PlaySfxAtPos(&this->actor, NA_SE_EN_BOSU_LAUGH_DEMO_K);
                Actor_PlaySfxAtPos(&D_809BEFD8->actor, NA_SE_EN_DEBU_LAUGH_K);
                Actor_PlaySfxAtPos(&D_809BEFD4->actor, NA_SE_EN_YASE_LAUGH_K);
            }
    ...
    if (this->unk_68A != 0) {
        ...
        Play_CameraSetAtEye(play, this->unk_68A, &sp44, &sp50);
        Play_CameraSetFov(play, this->unk_68A, this->unk6B0);
        ...
        if (arg0->unk594.elements[var_s4].info.bumperFlags & 2) {
            ...
            if (arg0->actor.colChkInfo.damage != 0) {
                ...
                if ((s8)arg0->actor.colChkInfo.health <= 0) {
                    ...
                    Actor_PlaySfxAtPos(&arg0->actor, arg0->unk6C0);
...
void func_809B9E00(EnKnight* this, PlayState* play) {
    ...
    for (i = 0; i < 15; i++) {
        sp88.x = randPlusMinusPoint5Scaled(7.0f);
        sp88.z = randPlusMinusPoint5Scaled(7.0f);
...
void func_809BA0CC(EnKnight* this, PlayState* play) {
    ...
    SkelAnime_Update(&this->unk194);
    Actor_PlaySfxAtPos(&this->actor, NA_SE_EN_BOSU_HEAD_FLOAT - SFX_FLAG);
    ...
    switch (this->unk148) {
        ...
        case 1:
            ...
            if (this->unk14A[1] == 0) {
                ...
                if (sp3C < 100.0f) {
                    Math_ApproachF(&this->actor.speedXZ, (f32)sREG(48) + 1.5f, 1.0f, 0.3f);
                }
                if (sp3C < 30.0f) {
                    this->unk148 = 2;
                    this->unk14A[0] = 0x32;
                ...
                Math_ApproachF(&this->actor.speedXZ, sREG(48) + 5.0f, 1.0f, 5.0f);
                if (this->unk14A[0] == 0 || sp3C < 50.0f) {
                    ...
                    if (Rand_ZeroOne() < 0.2f) {
                        ...
                        this->unk440.x = randPlusMinusPoint5Scaled(500.0f) + player->actor.world.pos.x;
                        this->unk440.y = Rand_ZeroFloat(100.0f) + player->actor.world.pos.y + 50.0f;
                        this->unk440.z = randPlusMinusPoint5Scaled(500.0f) + player->actor.world.pos.z;
                    }
                }
            }
...
void func_809BA978(EnKnight* this, PlayState* play) {
    ...
    if (this->unk148 != 1) {
        f32 var_fv1 = (this->unk148 == 2) ? 3000.0f : 1000.0f;
    ...
    switch (this->unk148) {
        case 0:
            Math_ApproachF(&this->actor.speedXZ, BREG(18) + 10.0f, 1.0f, 1.0f);
        ...
        case 2:
            ...
            player->unk_AE8 = 0x5A;
            Actor_PlaySfxAtPos(&this->actor, NA_SE_EN_BOSU_HEAD_BITE - SFX_FLAG);
...
void EnKnight_Update(Actor* thisx, PlayState* play) {
    ...
    if (this == D_809BEFDC) {
        ...
        if ((this->actionFunc != func_809BA978 || this->unk148 != 2) && !(BREG(76) & this->unk146)) {
